...
const SAVE_KEY = 'statisticsEvidence_v1';
const MAX_XP = 1000;
const RANKS = [
  {min:0,   name:'পর্যবেক্ষক',     icon:'🔍'},
  {min:100, name:'হিসাবরক্ষক',   icon:'📊'},
  {min:200, name:'বিশ্লেষক',     icon:'📐'},
  {min:300, name:'পরীক্ষক',     icon:'⚗️'},
  {min:400, name:'প্রমাণ-কারিগর',           icon:'⚖️'},
  {min:500, name:'সত্য-অনুসন্ধানী',     icon:'🔮'},
  {min:600, name:'প্রমাণের প্রভাবী',    icon:'🌟'},
  {min:700, name:'বুরহান অধিকারী',    icon:'👑'}
];
