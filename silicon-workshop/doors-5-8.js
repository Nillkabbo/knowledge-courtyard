...
<div class="dialogue en">You climbed the stairs. Tahmina was ticking paths on a schematic. "Seen Nurul's ledger? The give-and-take?"
"Yes. Now?"
"Now — the language that ledger is written in." She stopped the pen and turned. "What the elders do below is called repair. What I do is called design. Before either, the first task is reading the schematic. If you don't know the language, there's nothing to say. Sit — today I teach you to read."</div>
...
<li><strong>সেতু — দরজা ৬:</strong> নকশা পড়তে শিখলে — সিম্বল চেনা হলো। কিন্তু নকশার প্রতিটা তারে ঠিক কত ভোল্টেজ, কত কারেন্ট বইছে, তা এখনও অনুমান মাত্র। পরের দরজায় দুই আইন (কার্শফ) সেই অনুমানকে নিশ্চিত হিসাবে বদলাবে।</li>
</ul>`
  }
});
...
<li><strong>সেতু — দরজা ৭:</strong> এতদিন প্রতিটা ভোল্টেজ ছিল continuum — ০ থেকে ৫V-এর যেকোনো দশমিক মান, ডিভাইডার-অনুপাতে বদলাতে পারত। পরের দরজায় সেই একই ভোল্টেজ-জগৎ হঠাৎ দুই ভাগে সরল হয়ে যাবে — শুধু LOW আর HIGH, শুধু ০ আর ১। MCU-র প্রতিটা পিন এই সরলীকৃত জগতেই বাস করে, কিন্তু নিচে ঘুরছে সেই একই V-I-R পদার্থবিদ্যা।</li>
</ul>`
  }
});
...
"Then comes the best part." He set two push-buttons on the table, a bell, a battery. "A house owner says: two buttons — one downstairs, one up; either rings the same bell. Can you?"
...
<li><strong>সেতু — দরজা ৮:</strong> একটা ফ্লিপ-ফ্লপ ১ বিট মনে রাখে; ৮টা মিলে ১ বাইট, হাজার-হাজার বাইট মিলে রেজিস্টার-RAM-Flash। পরের দরজায় দেখবে এই ইটগুলো মিলে কীভাবে একটা গোটা 'শহর' — MCU — দাঁড়িয়ে যায়, প্রতিটা দপ্তরের নিজস্ব ঠিকানা নিয়ে।</li>
</ul>`
  }
});
...
<div class="dialogue en">Farhan laid a finger on the wall's datasheet — pages of register addresses. "Every department has an address. The court writes to addresses: 'Timer, count one second'; 'Gate-keeper five, be output, light the LED.' Writing to addresses is register-writing — your next door's language." He pointed at the blinking LED. "That glow is magic to you now; from tomorrow it becomes a sentence — one line of code, one letter from the court. Know the history too: in 1971 the 4004 became the first commercial microprocessor — born for a Japanese calculator, four bits, 740kHz. Then AVR (1996) put cities in hobbyists' hands; ARM (born 1985, drawn by two Acorn youngsters, Wilson and Furber) seated courts inside pocket phones; and ESP32 (2016) bolted a radio-minaret right onto the city gate — WiFi. The grain in your palm is that fifty-year staircase's last step — a two-dollar city, radio included." Then he pulled another board from the drawer — old, familiar: an Arduino Uno. "And keep this one marked separately: the ATmega328P. Our workshop now holds two chips, two costumes. <strong>The Uno is the transparent chip</strong> — its registers are so simple you can see straight through to the works; that's the one you'll learn on, hands-on. <strong>The ESP32 is the field chip</strong> — the one going into our real project, radio and all. As we go, you'll see the same task written in two languages for two chips: direct letters to the registers on the transparent chip, wrapped in a library on the field one. <em>The trick stays the same — only the costume changes.</em> Whoever can read both can sit down with any third chip's datasheet and make sense of it."</div>
...
<li><strong>সেতু — দরজা ৯:</strong> শহরের মানচিত্র চেনা হলো — CPU, RAM, Flash, GPIO — কিন্তু এই শহরকে এখনও একবারও হুকুম দেওয়া হয়নি। পরের দরজায় প্রথমবার সেই হুকুম লিখবে নিজের হাতে — C-কোডে একটা রেজিস্টার-বিট বদলে, প্রথম LED জ্বালিয়ে।</li>
</ul>`
  }
});
