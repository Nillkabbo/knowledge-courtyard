...
সিরিজ (পরপর, এক সড়ক):
  R_মোট = R₁ + R₂ + …        (দূরত্ব যোগ)
  I সবাই সমান (একটাই স্রোত)
  V ভাগ হয়: V₁ = I×R₁ (বড় রেজিস্টর বড় ভাগ)
  ব্যবহার: ভোল্টেজ-ডিভাইডার, LED+রেজিস্টর

সমান্তরাল (পাশাপাশি, বহু সড়ক):
  ১/R_মোট = ১/R₁ + ১/R₂ + …   (রাস্তা বাড়লে জ্যাম কমে)
  V সবাই সমান (একই দুই মাথা)
  I ভাগ হয়: I₁ = V/R₁ (ছোট রেজিস্টর বেশি টানে)
  ব্যবহার: বাস-ভোল্টেজ, সব মডিউল স্বাধীন

ডিভাইডার-সূত্র (MCU-র সেন্সর-সেতু):
  V_out = V_in × R₂/(R₁+R২)
  উদাহ: ৫V, R₁=R₂=১০k → ২.৫V (অর্ধেক)
  LDR-সেন্সর: R₁=স্থির ১০k, R₂=LDR (আলোয় ~১k,
...
মাল্টিমিটার-পাঠে দুই খাতার ব্যবহার:
  সিরিখ ভাব: লুপ ধরে V মাপো — কোন রেজিস্টরে কত পড়ল?
...
<svg viewBox="0 0 560 260" xmlns="http://www.w3.org/2000/svg">
  ...
  <text class="lbl" x="235" y="65">R১ = ১০k</text>
  <!-- midpoint node -->
  ...
  <text class="lbl" x="435" y="65">R২ = ১০k</text>
  <!-- bottom -->
  ...
  <!-- formula -->
  <text class="lbl-cyan" x="120" y="232" font-size="11">V_out = ৯V × R২/(R১+R২) = ৪.৫V</text>
...
<div class="secret-box"><div class="label">দরজা ৬ — রহস্য</div><div class="text">🛣️ জংশনে ঢোকা=বেরোনো (KCL), লুপে ওঠা=নামা (KVL) — দুই খাতা মিললে সার্কিট সৎ; না-মিললে সেখানেই ফাঁদ।<br><small>সিরিজ: এক I, V-ভাগ; সমান্তরাল: এক V, I-ভাগ; V_out=V_in·R₂/(R₁+R₂)। কার্শফ ১৮৪৫। কদর: ২৫:২।</small></div></div>`,
  senior:{
    title:"আজকের পাঠ — কী নিয়ে যাবে",
    body:`<ul class="checklist">
<li><strong>দুই সড়ক-চরিত্র আলাদা করা:</strong> সিরিখ = এক স্রোত-ভাগ-ভোল্টেজ; সমান্তরাল = এক ভোল্টেজ-ভাগ-স্রোত — যেকোনো নেটওয়ার্ক প্রথমে এই চোখে দেখো।</li>
...
<div class="dialogue">তুমি ভান্টে উঠলে। জাহেদ ভাই বেল-সেট খুলছিলেন। "ইকবাল সাহেবের কাছ থেকে? এক্সচেঞ্জ-হিসাব শিখেছ?"
...
<div class="dialogue">তারপর জাহেদ ভাই সবচেয়ে গোপন কথাটা বললেন — বেল-বোতলের খালি গ্লাসে চা ঢালতে ঢালতে: "১৯৩৭ সাল। আমেরিকার MIT-তে বিশ বছরের এক ছাত্র মাস্টার্স-থিসিস লিখল — নাম ক্লদ শ্যানন। আর আগে ১৮৫৪-তে ইংল্যান্ডের এক শিক্ষক জর্জ বুল লিখলেন যুক্তির বীজগণিত — ভাবলেন মানুষের চিন্তার নিয়ম মেলে। কেউ ভাবেনি দুই পাণ্ডুলিপি একদিন মিলবে। শ্যানন দেখালেন — বুলের প্রতিটা সূত্র তারে-সুইচে বসে: সিরিখ হলো 'এবং', পাশাপাশি 'অথবা', দুই-তারের ক্রস 'না'। সেদিনই তার-জাল থেকে কম্পিউটারের জন্ম-সনদ। আমার এই ভান্টের প্রতিটা বেল-সার্কিট তাদেরই নাতি-নাতনি।" তিনি দুটো NAND-গেটের খসড়া এঁকে দেখালেন — একটার আউটপুট অন্যটার ইনপুটে ফিরে যায়, দুই-ই পরস্পরকে ধরে থাকে: "এই দেখো স্মৃতির পরমাণু — ফ্লিপ-ফ্লপ। একবার বলল '১' — ধরে রাখে যতক্ষণ না বলা হয় '০ হও'। চিপের ভেতরে কোটি কোটি এমন জোড়া — তোমার ফোনের ছবি, গান, এই মুহূর্তের কথা — সব এই ছোট্ট আঁকড়ে-থাকা জোড়ার ভিড়ে।"</div>
...
তিন ইট (সুইচের ভাষায়):
  AND  = সিরিখ বাটন — দুই-ই চাপলে তবেই পথ
...
<div class="secret-box"><div class="label">দরজা ৭ — রহস্য</div><div class="text">🔀 সব যুক্তি তিন ইটে — এবং/অথবা/না; NAND-এ সব ইট; দুই NAND-এর আঁকড়ানো জোড়ায় স্মৃতির জন্ম।<br><small>লেভেল-চুক্তি ০.৮/২V-ফাঁক; বুল ১৮৫৪ + শ্যানন ১৯৩৭ = তার-থেকে-কম্পিউটার সেতু; ফ্লিপ-ফ্লপ = ১ বিট। নূর: ২৪:৩৫।</small></div></div>`,
  senior:{
    title:"আজকের পাঠ — কী নিয়ে যাবে",
    body:`<ul class="checklist">
<li><strong>তিন ইট সুইচে হাতে-বোধ:</strong> সিরিখ=AND, পাশাপাশি=OR, ক্রস=NOT — বাটন-বেল দিয়ে নিজে জুড়ে দেখো; ট্রুথ-টেবিল তখন মুখস্থ নয়, অভিজ্ঞতা।</li>
...
doors.push({
  ...
  spirit:"শহর ও দরবার — প্রতিটা অঙ্গনায় নিজস্ব দপ্তর, এক কেন্দ্রে হুকুম (৬২:১০-এর মিলাদ-শহর-চেতনা; ২৭:৩৪-৩৮ সাবা-রানীর দরবার)",
