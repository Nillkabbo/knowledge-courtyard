...
<p class="scene-setting en">The first door. The Patuatuli workshop — ten in the morning, rickshaw horns outside, stacks of dead radios within, old vacuum tubes hung on the wall, the smell of tin smoke and rosin. At the repair bench, the owner — Uncle Mostafiz — nearly seventy, a cotton apron over his white panjabi, and his signature: a brass monocle clamped to his right eye — a keepsake from the vacuum-tube days; to inspect a fine joint he sets the monocle, brings his face close to the board, and says, "There... there's the story." Sounds — a multimeter's beep, an old radio playing half-volume somewhere behind.</p>
...
তিন রূপ (একটাই সমীকরণ, তিন প্রশ্নের জবাব):
  I = V / R    "কত যাবে?"      ৯V ÷ ১০০Ω → ৯÷১০০ = ০.০৯ A = ৯০ mA
  V = I × R    "কত পড়ল ধাক্কায়?"  ২০ mA আগে A বানাও (÷১০০০) = ০.০২A → ০.০২×৩৩০ = ৬.৬ V
  R = V / I    "কত বাধা দরকার?"  ২০ mA = ০.০২A → ৩.৩V ÷ ০.০২A = ১৬৫ Ω

LED জ্বালানোর হিসাব (তোমার প্রথম ডিজাইন-সিদ্ধান্ত):
  লক্ষ্য: লাল LED, Vf≈২V, চাও ১৫ mA
  সোর্স ৫V → রেজিস্টরে পড়বে ৫−২ = ৩V (LED নিজে ২V খরচ করে, বাকিটা রেজিস্টরের ভাগ)
  R = V/I বসানোর আগে mA-কে A বানাও: ১৫mA = ০.০১৫A
  R = ৩V ÷ ০.০১৫A → ৩÷০.০১৫ = ২০০Ω  (২২০Ω স্ট্যান্ডার্ড নাও)
...
<li><strong>সেতু — দরজা ২:</strong> রেজিস্টর শুধু বাধা দেয় — কিন্তু দুই ভাই বাকি: যে চার্জ জমায় (ক্যাপাসিটর), যে প্রবাহের জড়তা দেয় (ইন্ডাক্টর)। তিন ভাই মিলে সময়ের খেলা শুরু করে।</li>
</ul>`
  }
});
...
ক্যাপাসিটরের ভাষা:
  ...
  উদাহ: ১০μF × ১০kΩ → ১০×১০⁻⁶ × ১০×১০³ = ১০০×১০⁻³s = ১০০ms (blink-টাইমারের প্রাণ)
...
LC দোলা (দুই ভাইয়ের দোলনা):
  f = 1 / (2π√(LC))    রেডিও-টিউনিং এখানেই — L বা C বাড়লে হর বড় হয়,
                      f কমে (বড় কয়েল/ক্যাপ = ধীর দোলা); নির্দিষ্ট
                      ফ্রিকোয়েন্সি ধরে রাখা, বাকি সব ছাঁকা
...
ইম্পিডেন্স (Z) — AC-জগতে তিন ভাইয়ের মিলিত বাধা:
  X_C = 1/(2πfC)  → হর-এ f থাকায় f বাড়লে বাধা কমে (উচ্চ-ফ্রি পাস)
  X_L = 2πfL      → f সরাসরি গুণে থাকায় বাড়লে বাধা বাড়ে (নিম্ন-ফ্রি পাস)
...
<li><strong>সেতু — দরজা ৩:</strong> তিন ভাই — R, C, L — কারেন্ট যেদিক থেকেই আসুক একই আচরণ করে, দিক তাদের কাছে অর্থহীন। পরের দরজায় এমন এক কম্পোনেন্ট আসছে যার কাছে দিক-ই সব — এক দিকে দরজা খোলা, উল্টো দিকে বন্ধ। সুইচ আর অ্যামপ্লিফায়ারের জগৎ সেখান থেকেই শুরু।</li>
</ul>`
  }
});
...
"Yes. Now?"
He pulled a lit LED free and set it on his palm. "The three brothers are passive soldiers — block, store, swing. Today you meet the active soldier. This tiny thing decides on its own — pass, or refuse. Its name is diode. To me it teaches honesty."</div>
...
<div class="dialogue en">He set a diode on the table — black body, silver band at one end. "Silicon by itself is as inert as a blank canvas — pure, it just sits there. Dope it: phosphorus gives extra electrons (N-region), boron gives holes (P-region). Join them — a guard-zone forms at the border (depletion). The result is incredible: from one side, past a 0.7-volt toll, it passes; from the other — shut. Honest in one direction its whole life." He smiled. "To me this is electronics' first moral character. Hang a light on this one-way door, and you've got the LED — red junctions need ~2V (Holonyak showed the first in 1962), blue over 3 (Akasaki-Amano-Nakamura — the 2014 Nobel). And the chief of these gatekeepers — the transistor: three scientists built it at Bell Labs in December 1947, Nobel 1956. A small base-signal opens a great flow — a trusted gatekeeper: motionless without instructions, but able to throw open a mountain's worth of power on command."</div>

<div class="photo-frame"><img src="photos/diode.jpg" alt="1N400x সিরিজের ডায়োড — শরীরের স্ট্রাইপ দিক বলে"><div class="photo-cap">1N400x সিরিজের ডায়োড — শরীরের স্ট্রাইপ (ব্যান্ড) ক্যাথোডের দিক বলে · ছবি: Wikimedia Commons (মুক্ত লাইসেন্স)</div></div>
...
LED — আলো-বিকিরণকারী জংশন:
  ...
  উদাহ: ৫V সোর্সে লাল: (৫−২) = ৩V বাকি; ১৫mA = ০.০১৫A ধরে
       ৩ ÷ ০.০১৫ ≈ ২০০Ω → ২২০Ω স্ট্যান্ডার্ড
...
ইন্টারভিউ-কোণ:
  ...
  সাইন-ঢেউয়ের ভাষা আলাদা:
    V_peak = √২ × V_RMS          (শিখর; √২≈১.৪১৪ — সাইন-ঢেউয়ের RMS-থেকে-শিখর গুণক)
    V_p-p  = ২ × V_peak          (শিখর-থেকে-শিখর)
  উদাহ: দেয়ালের ২২০V মানে RMS →
    ২২০ × ১.৪১৪ ≈ ৩১১V পিক! — ক্যাপ/ডায়োডের রেটিং পিকে সাজাও
...
<div class="diag-cap">সুইচ হিসেবে ব্যবহার করলে ট্রানজিস্টরকে অর্ধেক খুলে রাখা চলে না — <em>পুরো</em> খুলতে হয় (saturation), নইলে V_CE-তে ভোল্টেজ পড়ে আর সে গরম হয়। তাই বেসে হিসাব-মতো নয়, হিসাবের চেয়ে বেশি প্রবাহ দাও: β ধরো ১০, ডেটাশিটের ১০০ নয়। এখানে ২.৬mA বেস-প্রবাহ × অর্জিত β ৩৮ ≈ ৯৯mA — ঘোষিত ১০০mA লোড প্রায় পুরোটাই অনায়াসে টানে।</div>
</div>
...
<li><strong>সেতু — দরজা ৪:</strong> প্রতিটা LED, প্রতিটা রিলে-কয়েল কারেন্ট খায় — কিন্তু কতটা, কতক্ষণ, কোন সোর্স থেকে? এই খাতা এখনও খোলা হয়নি। পরের দরজায় নুরুল ভাই সেই রেশন-হিসাব শেখাবেন — ব্যাটারি, রেগুলেটর, ডিউটি-চক্র।</li>
</ul>`
  }
});
...
doors.push({
  ...
  recall:{
    ...
    a:"কারণ ব্যাটারি একটা রিযিকের থালা — মোট বরাদ্দ সীমিত। পাওয়ার-বাজেট: প্রতিটা যন্ত্রাংশের গড় কারেন্ট তালিকা করো (MCU সক্রিয়/ঘুম, সেন্সর, রেডিও TX/RX, LED), যোগ করো — সেটাই মোট চাহিদা। ব্যাটারির সঞ্চয় মাপা হয় mAh-তে: ২০০০mAh মানে ২০০০mA এক ঘণ্টা চলতে পারবে; সময়=ধারণক্ষমতা÷কারেন্ট সূত্রে ৫০mA চললে ২০০০÷৫০ = ৪০ ঘণ্টা, আর ২৪ দিয়ে ভাগ করলে ৪০÷২৪ ≈ ১.৭ দিন। এনার্জি হিসাবে: mAh-কে আগে Ah বানাও (২০০০mAh = ২Ah), তারপর Wh=V×Ah → ৩.৭V×২Ah = ৭.৪Wh। রেগুলেটরের দক্ষতাও ধরো — LDO সরল কিন্তু ব্যর্থ-তাপে শক্তি নষ্ট করে (drop × I), buck (স্টেপ-ডাউন সুইচিং) ৮৫-৯৫% দক্ষ কিন্তু নয়েজ-তালিকা লম্বা। স্লিপ-মোডই IoT-এর প্রাণ: MCU ঘুমালে μA-তে নামে, বছরের ব্যাটারি-জীবন তখনই সম্ভব — বাজেট মানে শুধু যোগ নয়, সময়-ভাগ (ডিউটি-চক্র) ভিত্তিক গড়: গড় I = (চালু-সময়×I_চালু + ঘুম-সময়×I_ঘুম)/মোট।",
...
<div class="dialogue">তিনি খাতা খুলে দেখালেন — একটা আসল প্রজেক্টের পাতা। দেখো: "MCU ঘুম: ০.০২mA / জাগা ১০mA (১% সময়) → (০.০১×১০mA)+(০.৯৯×০.০২mA) ≈ ০.১২mA গড়। সেন্সর: ০.৫mA (সবসময়-চালু ছোট সার্কিট)। রেডিও — প্রতি ১০ মিনিটে (৬০০সে) মাত্র ৩সে পাঠায়, তাই ডিউটি ৩÷৬০০ ≈ ০.৫%; TX ১০০mA হলে ০.০০৫×১০০ = ০.৫mA গড়। তিন ভাগ যোগ করি: ০.১২+০.৫+০.৫ ≈ ১.১mA মোট গড়। সময়=ধারণক্ষমতা÷গড়-কারেন্ট বসাই: ২০০০mAh ÷ ১.১mA ≈ ১৮১৮ ঘণ্টা, ২৪ দিয়ে ভাগ করলে ≈ ৭৫ দিন!" তুমি চোখ বড় করলে — একই ব্যাটারি, সাত দিনের বদলে পঁচাত্তর। নুরুল ভাই হাসলেন: "জাদু নয় — ঘুম। সময়-ভাগের হিসাব। যন্ত্র সারাক্ষণ জাগলে সে ভোক্তা, ওয়াক্ত-মতো জাগলে সে যত্নবান। আর রেগুলেটরের গল্প — LDO সোজা রাস্তা কিন্তু ঢালুতে শক্তি ফেলে (dropout×I তাপে যায়), buck-কনভার্টার ঘুরপথ কিন্তু কম খায় (৮৫-৯৫%)। সস্তা নয়, দক্ষতা কিনতে হয় — নয়েজ আর জটিলতার দামে।"</div>
<div class="dialogue en">He opened the ledger to a real project page: "MCU sleep 0.02mA, awake 10mA at 1% → average 0.12mA. Sensor 0.5mA. Radio: 3 seconds per 10 minutes at 100mA → 0.5mA average. Total ≈1.1mA. 2000mAh ÷ 1.1 ≈ 1818 hours ≈ 75 days!" Your eyes widened — same battery, seven days became seventy-five. Nurul smiled: "Not magic — sleep. Duty-cycle arithmetic. A device awake around the clock is a spendthrift; awake on schedule, a careful keeper. And regulators: LDO is the straight road but spills energy on the slope (dropout×I as heat); the buck converter takes the winding road but eats less (85-95%). Efficiency isn't free — you pay in noise and complexity."</div>
...
ব্যাটারি-জীবন:
  ...
  ২০০০mAh ÷ ৫০mA → ২০০০÷৫০ = ৪০ ঘণ্টা (÷২৪ করলে ≈১.৭ দিন)
  এনার্জি: mAh→Ah আগে বানাও (২০০০mAh = ২Ah), Wh = V × Ah → ৩.৭V × ২Ah = ৭.৪Wh

ডিউটি-চক্রে গড় (IoT-এর প্রাণ):
  গড় I = (t_চালু × I_চালু + t_ঘুম × I_ঘুম) / (t_চালু + t_ঘুম)
  উদাহ: চালু-ভাগ ১%=০.০১, ঘুম-ভাগ ৯৯%=০.৯৯ বসাও —
    (০.০১×১০mA) + (০.৯৯×০.০২mA) = ০.১ + ০.০১৯৮ ≈ ০.১২mA
    সারাক্ষণ-জাগা ১০mA-র সাথে তুলনা: ১০÷০.১২ ≈ ৮৩ গুণ সাশ্রয়!

রেগুলেটর-প্রজাতি:
  LDO (linear): Vout স্থির, বাড়তি V×I তাপে খোয়ানো
    — সরল, শান্ত (নয়েজ-কম); দক্ষতা ≈ Vout/Vin বসিয়ে ভাগ করো
    ৩.৭→৩.৩V: ৩.৩÷৩.৭ = ০.৮৯১ ≈ ৮৯%
    ১২→৩.৩V: ৩.৩÷১২ = ০.২৭৫ ≈ ২৮% — এখানে LDO নিষেধ, বাকিটা তাপে ওড়ে!
...
<li><strong>সেতু — দরজা ৫:</strong> এতক্ষণ সবই কাগজে-কলমে হিসাব — V, I, R, mAh, সংখ্যায় সংখ্যায়। পরের দরজায় সেই হিসাব বাস্তব বোর্ডে নামবে: নকশা কীভাবে পড়া হয়, মাল্টিমিটার-অসিলোসকোপ দিয়ে দাবি কীভাবে যাচাই হয়।</li>
</ul>`
  }
});
