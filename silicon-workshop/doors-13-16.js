...
<p class="scene-setting en">The thirteenth door. Ground floor of the old post-office building at Patuatuli's corner — Hasan's retired den: heaps of old wax-sealed envelopes in a glass case, on the wall, blank money-ledger forms from his working years, three modern dev boards on the table, each with its own wire-bunch. Hasan — past sixty, white hair, dhuti-panjabi, reading glasses, and his signature: an old steel date-stamp always in his breast pocket — whenever a number or date enters the conversation, out comes the stamp, twirled in hand, as if the spoken number too must be made official. Old paper, glue-pot, tea; street horns, board-wires clicking, a postman's bicycle bell far off.</p>
...
<div class="dialogue en">You greeted him on the stairs. Hasan lifted his glasses and smiled. "Been to see Rubel's partial-power trick? So the chip can see now, and touch with measured power. Then?"
...
<div class="dialogue en">Hasan set the three boards and let you drive each. First UART: every character the chip sent in your terminal — "this works with humans too, and between two boards — a private mail-road." Then SPI: the screen flickered to life, crisp and bright — "see that speed! But note — a separate select-wire per slave. Not letters, finger-signals; add a device, add a wire." Finally I2C: address 0x68 to the DS3231 — time came back from its registers, a tiny pull on the ACK bit! "Saw that acknowledgment? That's the very soul of a post office — not just sent, but <em>known to have arrived</em>." Then the two-master story — both starting on one road, harmlessly: whoever writes 1 and sees 0 on the wire yields — "in the post office I called it courteous contention; in chip-tongue, arbitration. One road, no egos."</div>
...
UART — দুই-পক্ষ চিঠি (মানুষের সিরিয়াল-জানালা):
  ...
  বিট-সময়ের হিসাব (৯৬০০ baud ধরে): baud মানে সেকেন্ডে বিট-সংখ্যা,
    তাই এক-বিটের সময় = ১ ÷ ৯৬০০ সে. = ০.০০০১০৪ সে. = ১০৪μs
    ফ্রেমে বিট-সংখ্যা = ১(start) + ৮(data) + ১(stop) = ১০ বিট
    ফ্রেম-সময় = ১০ × ১০৪μs = ১০৪০μs ≈ ১.০৪ms — এই সময়েই দুই প্রান্তের ঘড়ি মিলতে হবে
  'A' তারে যাওয়ার পথ: 'A' = 0x41 = 0b01000001 (বিট৭…বিট০ ক্রমে লেখা)
    তারে যায় উল্টো দিক থেকে — LSB (বিট০) সবার আগে:
    বিট০=১, বিট১=০, বিট২=০, বিট৩=০, বিট৪=০, বিট৫=০, বিট৬=১, বিট৭=০
    তার-ক্রম: start(নিম্ন) → ১,০,০,০,০,০,১,০ → stop(উচ্চ) — মোট ১০ ধাপ, ১০৪μs করে
...
I2C — ঠিকানা-চিঠি (দুই তার, পুল-আপ বাধ্য):
  ...
  বিট-শিফটের ধাপ (0x68 কীভাবে বাসে 0xD0 হয়):
    0x68 = 0b01101000 (৭-বিট ঠিকানা এই বাইটের উপরের ৭ ঘরে বসানো)
    এক-ঘর বামে-শিফট (×২, R/W-বিটের জায়গা খালি করতে): 0b01101000 → 0b11010000
    সর্ব-ডান ঘরে R/W বসাও (write=০): 0b11010000 | 0 = 0b11010000 = 0xD0
...
<li><strong>সেতু — দরজা ১৪:</strong> এতক্ষণ ধরে নিয়েছি চিপ জেগে আছে, প্রস্তুত। কিন্তু পাওয়ার-অন হওয়া মাত্রই কি কোড চলা শুরু হয়? আর একসাথে অনেক কাজ চালাতে হলে কে ঠিক করে কোনটা আগে? পরের দরজায় বুট-প্রক্রিয়া আর RTOS-শিডিউলার।</li>
</ul>`
  }
});
...
<div class="dialogue en">You entered quietly. Arif slid the loupe-chain off his finger and gestured at the memory map. "Seen Hasan's post office; you know addresses. Now — the city's land-book." He showed three regions — Flash, RAM, peripherals. "Behind every address is one specific thing — code, a variable, or a device. A letter to the wrong address gets exactly what it deserves — hardfault." He turned to the boot map. "Today, the final preparation — three questions: how the city wakes up, who gets to go first on the road, and what eye can spot a sickness."</div>
...
<div class="stat-grid">
<div class="stat-card"><div class="sc-num">0x0000</div><div class="sc-label">রিসেট-ভেক্টর — AVR-এ জাগরণের প্রথম ঠিকানা; ARM-এ প্রথম এন্ট্রি স্ট্যাক-পয়েন্টার মান, দ্বিতীয়টি রিসেট-হ্যান্ডলার</div></div>
...
<div class="dialogue en">At dusk Arif raised the loupe to read the boot map's last line, then lowered it: "Pilgrims stop at the miqat — at fixed stations they put on the ihram, set their intention, then set off. The chip's waking is the same: five miqats — vector, stack, data, clock, bootloader — intention fixed at every layer, and only then does the journey of main() begin. A developer who knows these layers has no 'magic' left — even boot failure becomes an investigable mystery, not darkness. And remember — the mightier the scheduler, the subtler the trial: priority inversion and deadlock — memorize these two hunters' names before you go. Tomorrow, the last applied door — Sadiya: speaking with the wind. The garden's harvest goes to the cloud."</div>
...
<div class="callout build"><span class="co-icon">🛠️</span><div><strong>নির্মাণ-পর্ব 14 — বুট-শৃঙ্খলা ও নাড়ি-পরীক্ষা:</strong> লিংকার-খাতা: .text/.data/.bss-এর ম্যাপ দেখলাম — ফ্ল্যাশ-দখল ৪২%, RAM ১৮% (স্ট্যাক-সতর্কতাসহ)। হিসাবের পথ: <code>avr-size</code>/বিল্ড-টুল যা দেয় তা কাঁচা-বাইট — শতাংশ বার করা লাগে নিজে: ফ্ল্যাশ% = (ব্যবহৃত .text+.data বাইট ÷ বোর্ডের মোট ফ্ল্যাশ-ধারণক্ষমতা) × ১০০; RAM% একই সূত্রে (.data+.bss+স্ট্যাক-জন্য-রাখা-বাজেট) ÷ মোট RAM দিয়ে — এই দুই ভাগফলই আমাদের ৪২% আর ১৮%। <strong>নিয়ম-স্থাপন:</strong> ডিবাগ-প্যাড বোর্ডে (আমাদের ESP32-এ <em>JTAG</em>: TMS·TCK·TDI·TDO — ARM-বোর্ডে হতো ২-তারের SWD) + প্রথম-বুট-লগ; watchdog-স্বাক্ষর যাচাই। ডিবাগ-প্রোব লাগিয়ে এক-ব্রেক-পয়েন্টে ওয়াক্ত-ফাংশনের ভেতরে ঢুকে দেখা — শহর-পতনের রহস্য নয়, এখন সব তদন্তযোগ্য।</div></div>
...
<li><strong>সেতু — দরজা ১৫:</strong> এতদিন সবকিছু এক বোর্ডের ভেতরে, তারে-তারে বাঁধা। পরের দরজায় সেই বোর্ড প্রথমবার তার ছাড়া কথা বলবে — বাতাসে, দূরের এক সার্ভারের সাথে।</li>
</ul>`
  }
});
...
হেডার-হিসাব — কেন ২ বাইট (HTTP-হেডার-পাহাড়ের বিপরীতে):
  ফিক্সড-হেডারের গঠন: ১ বাইট কন্ট্রোল (প্যাকেট-টাইপ+ফ্ল্যাগ)
    + ১-৪ বাইট 'বাকি-দৈর্ঘ্য' (ভ্যারিয়েবল-লেনদার এনকোডিং)
  ছোট-বার্তায় (১২৭ বাইটের কম payload) বাকি-দৈর্ঘ্য মাত্র ১ বাইটেই লেখা যায়
  তাই ন্যূনতম মোট = ১(কন্ট্রোল) + ১(দৈর্ঘ্য) = ২ বাইট — বাকিটা তোমার payload
...
বেতার-প্রজাতি-বাছাই (দূরত্ব×খরচ×গতি):
  ...
  ── অ্যান্টেনার দৈর্ঘ্য কোথা থেকে আসে (c = fλ) ──────
  সূত্র উল্টে সাজাও: তরঙ্গদৈর্ঘ্য λ = c ÷ f
    c (আলোর গতি) ≈ ৩×১০⁸ মি/সে., f (WiFi/BLE) = ২.৪GHz = ২.৪×১০⁹ Hz
    λ = (৩×১০⁸) ÷ (২.৪×১০⁹) = ০.১২৫ মি = ১২.৫cm — পুরো-তরঙ্গের দৈর্ঘ্য
  মনোপোল-অ্যান্টেনা বাঁধে λ/৪-এ (সবচেয়ে দক্ষ ছোট রূপ):
    ১২.৫cm ÷ ৪ = ৩.১২৫cm ≈ ৩.১cm — এই মাপেই তারের-অ্যান্টেনা কাটা হয়
...
<div class="dialogue en">Sadiya let you run the whole chain: ESP32 onto WiFi → connect to broker → publish temperature → your number surfacing in the dashboard-subscriber's terminal row; then the reverse — a command published from the phone, the board's LED answering. Wind both ways. On the success she touched her pendant — the rite. "Remember Aunt Ayesha teaching you to swing the cannon — you've heard that story from Book 55? The broker works the same way — one pivot point aiming a million devices. The Quran says — those who rank themselves in rows for Allah's path are like a well-built wall (61:4). That wall is my broker-image: each device in its row, one center, one melody. If one dances alone the jamaat breaks — so when a client-id comes twice, the broker drops the old one; discipline preserved."</div>
...
<div class="dialogue en">As night fell, Sadiya turned the antenna-stand toward the window. "Last word — on security. The wind belongs to all; speaking on the wind means speaking before the crowd. TLS is the secret tongue, the certificate the identity-card, the signature the seal — without all three, you can speak on the internet — but no one should trust what you say. If your device someday becomes someone's door-lock, someone's medicine-mixer — remember the boy who played with lights: a weak lock is no lock. Tomorrow, the last door — everyone returns. Mostafiz chacha has called; the reckoning of all sixteen doors comes together in one garden."</div>



<div class="photo-frame"><img src="photos/d15-antenna.jpg" alt="ESP32-C3 NodeMCU বোর্ড — অ্যান্টেনা-সহ WiFi মাইক্রোকন্ট্রোলার"><div class="photo-cap">ESP32-C3 NodeMCU বোর্ড — বাতাসের দরজার পাখির আসল শরীর · ছবি: Wikimedia Commons (মুক্ত লাইসেন্স)</div></div>
...
<li><strong>সেতু — দরজা ১৬:</strong> এখন হাতে সব উপকরণ — ভোল্টেজ থেকে ভালভ, ইন্টারাপ্ট থেকে ইন্টারনেট। শেষ দরজায় এই ষোলোটা টুকরো এক ডিভাইসে জোড়া লাগবে — আর দেখবে, প্রতিটা আগের দরজাই এই একটা যন্ত্রের একেকটা অঙ্গ ছিল।</li>
</ul>`
  }
});
...
doors.push({
  ...
  story:`
<p class="scene-setting">ষোলো দরজা — শেষ। আবার সেই প্রথম কারিগরখানার মেরামত-টেবিল, কিন্তু আজ সন্ধ্যা — মোস্তাফিজ চাচার টেবিলে নতুন জিনিস: একটা সম্পূর্ণ তৈরি ডিভাইস — ছোট্ট বক্স, তাতে সেন্সর-প্রোবের তার, সোলার-প্যানেলের পাত, অ্যান্টেনা; পাশে ল্যাপটপে জীবন্ত ড্যাশবোর্ড। আর ঘরটা আজ ভরা: দরজার কারিগররা সবাই এসেছেন — রফিক মামা (ড্রয়ার-খুঁজতে-না-লাগা), শামসুল কাকা (জিভের ফিতে-ছাড়া), নুরুল ভাই (খাতা-ঝুলি-সহ), তাহমিনা আপা (লাল পেন-সহ), ইকবাল সাহেব (প্লাগ-ঘোরানো), জাহেদ ভাই (কানে-তামা-ফাঁস), ফারহান ভাই (কবজি-কয়েল), শারমিন আপা (তিন-আংটি), মুয়াজ ভাই (তাসবিহ-সহ), রুবেল ভাই (কানে-পেন্সিল), হাসান সাহেব (সীল-সহ), আরিফ ভাই (লুপ-চেইন), সাদিয়া আপা (পেন্ডেন্ট-সহ) — তেরোজন দাঁড়িয়ে; মোস্তাফিজ চাচাসহ চৌদ্দ কারিগরই আজ এক ঘরে, সবার চোখ টেবিলের বক্সটায়। গন্ধ — সন্ধ্যার চা, কারিগরখানার চিরচেনা টিন-রোজিন। শব্দ — জানালার বাইরে বৃষ্টি নামছে মৃদু, দূরে মিনারে মাগরিবের আযানের অপেক্ষা; ভেতরে সবার নিঃশ্বাস।</p>
<p class="scene-setting en">The sixteenth door — the last. The same first repair-bench, but evening now — and on Mostafiz's table a new thing: a finished device — a small box with a sensor-probe wire, a solar-panel leaf, an antenna; beside it a laptop with a live dashboard. And the room is full: the doors' craftsmen have all come — Rafiq, Shamsul, Nurul, Tahmina, Iqbal, Jahed, Farhan, Sharmin, Muaz, Rubel, Hasan, Arif, Sadiya — thirteen standing; with Mostafiz himself, all fourteen craftsmen of the workshop in one room, all eyes on the box. Evening tea, the workshop's eternal tin-and-rosin; soft rain beginning outside, the minaret awaiting the maghrib call, and inside — everyone's breath.</p>
...
<div class="dialogue en">Mostafiz, monocle to his eye, raised the box — then opened it: inside, every face you knew. "No new lesson today. Today — reconciliation." He looked at you. "Tell me — what is this box?"
...
void publishReading(PubSubClient &amp;m) {
  ...
  raw /= 10;
  float v = raw * 3.3f / 4095.0f;          // ⚠ ESP32 ADC ১২-বিট: ২^১২ = ৪০৯৬ ধাপ,
                                            //   গণনা ০ থেকে শুরু → সর্বোচ্চ ঘর ৪০৯৫; পূর্ণ-স্কেল ৩.৩V ধরলে
                                            //   raw=৪০৯৫ হলে v = ৪০৯৫×৩.৩÷৪০৯৫ = ৩.৩V (সীমা মেলে)
  int pct = constrain(
...
void valve(int duty) {                 // ০…২৫৫ — ইনফাক-মাপ (৮-বিট রেজোলিউশন: ২^৮=২৫৬ ধাপ, ০-থেকে-গোনা → শেষ ঘর ২৫৫)
...
void setup() {
  ...
  WiFi.begin(SSID, PASS);
  if (!waitForWiFi(15000)) deepSleep(15 * 60);   // ১৫ × ৬০ = ৯০০ সে. (=১৫ মিনিট) — না পেলে ঘুমাও, পরে দেখা
  ...
  esp_sleep_enable_timer_wakeup(15ULL * 60 * 1000000);   // ধাপে-ধাপে: ১৫মিনিট×৬০সে./মিনিট = ৯০০সে.;
                                                           //   ৯০০সে.×১০,০০,০০০μs/সে. = ৯০,০০,০০,০০০μs — দরজা ১১
...
// ☐ ঘুম-জাগার হিসাব setup()-এ ☐ WiFi না পেলে ঘুমে ফেরার পথ
  ...
  ── দুই-বিন্দু ক্যালিব্রেশন: জাদু-সংখ্যা বাদ ──────
    ...
    এক-উদাহরণ (আমাদের কোডের RAW_DRY=৩২০০, RAW_WET=১২৫০ ধরে):
      মাঠে raw=২২২৫ পড়লে → pct = (২২২৫−৩২০০)×১০০÷(১২৫০−৩২০০)
        = (−৯৭৫×১০০)÷(−১৯৫০) = −৯৭৫০০÷−১৯৫০ = ৫০ — অর্থাৎ raw=২২২৫ মানে ৫০% আর্দ্র
    ক্লিপ + গড়-১০ (মিডিয়ান-স্পাইক-মুছা) যোগ করো
  এক-লাইন EMA (স্মুথিং): y += α(x − y); α≈০.২
    ধাপে-ধাপে-উদাহরণ: আগের-মসৃণ-মান y=৫০%, নতুন-কাঁচা-পাঠ x=৬২%, α=০.২
      y_নতুন = y + α×(x−y) = ৫০ + ০.২×(৬২−৫০) = ৫০ + ০.২×১২ = ৫০ + ২.৪ = ৫২.৪%
      (এক-লাফে ৬২ নয়, ৫০ থেকে ৫২.৪-এর দিকে সরল — স্পাইক-প্রতিরোধী মসৃণতা)
  ভাষা-পার্থক্য: রেজোলিউশন (ধাপ-সংখ্যা) ≠ নির্ভুলতা
  (সত্যের-কাছাকাছি) ≠ যথার্থতা (পুনরাবৃত্তি) —
...
<div class="dialogue en">The maghrib adhan rose — Muaz stood first, all stood; returning after prayer, Mostafiz placed the box in your hands. "Sixteen doors were mine; now yours. The verse we began with — lightning, fear and hope (30:24)? Now hear the last: 'We offered the trust to the heavens, the earth, the mountains; they shrank from it — but man bore it' (33:72). Just think — the sky holds lightning, the earth holds grain, the mountain holds ore; but the <em>trust</em> — duty, faith, justice — those they dared not take. Man did. The machine you will build is a trust too: someone's water-account, someone's medicine-hour, someone's door-lock. Learning voltage and code is half the work; the other half is that khilafah — if you carry it, carry it faithfully. Take this box. Let the next be your own — and on its schematic, next to your name, write: Trustee." Rain had gathered outside; Rafiq slipped the sensor-probe into a flower pot — the dashboard's first curve rose: 62%. Sixteen doors smiled together.</div>



<div class="photo-frame"><img src="photos/solar.jpg" alt="ছোট সোলার-প্যানেল — বক্সের পিঠের রিযিক-সংগ্রাহক"><div class="photo-cap">ছোট সোলার-প্যানেল — মাঠ-পাখির পিঠে বসা রিযিক-পাত (দরজা ৪-এর চেইনের প্রথম আঙুল) · ছবি: Wikimedia Commons (মুক্ত লাইসেন্স)</div></div>
...
<li><strong>সেতু — বইয়ের বাইরে:</strong> এই ষোলো দরজা ভিত্তি দিল, দালান নয়। পরের ধাপ বই দেবে না — নিজের হাতে একটা প্রয়োজন খুঁজে বের করা, ভুল করা, মেরামত করা। কারিগরখানার দরজা এখন তোমার নিজের ঘরে।</li>
</ul>`
  }
});
