...
const RANKS = [
  ...
  {min:150,  name:'সোল্ডার-শিক্ষানবিশ', icon:'🔥'},
  {min:300,  name:'কম্পোনেন্ট-চেনা',   icon:'🧰'},
  {min:450,  name:'সার্কিট-পাঠক',      icon:'📐'},
  {min:600,  name:'লজিক-কারিগর',      icon:'⚡'},
  {min:750,  name:'চিপ-প্রোগ্রামার',   icon:'💾'},
  {min:900,  name:'ফার্মওয়্যার-গড়নকার', icon:'🛠️'},
  {min:1050, name:'বাস-স্থপতি',        icon:'🏗️'},
  {min:1200, name:'তড়িৎ-সংযোগকারী',   icon:'📡'},
  {min:1350, name:'সিলিকনের ওস্তাদ',   icon:'👑'}
];
