...
নতুন-প্রজেক্টের-প্রথম-সপ্তাহ (স্মৃতি-সূত্র):
  ...
  <div class="compare"><div class="cmp-card cmp-bad"><div class="cmp-label">❌ তালিকা-মুখস্থ</div>২৬টি তাবিজ পড়ে "সব-জানা" ঘোষণা — হাতে-না-ধরা যন্ত্র মরীচিকা; প্রজেক্টে প্রথম-সপ্তাহেই কাশি।</div><div class="cmp-card cmp-good"><div class="cmp-label">✅ পূর্ণ-তাঁত-পরীক্ষা</div>এক-ক্লিকের-যাত্রা নিজে-বানানো — প্রতিটি স্তরে হাত রাখা; তখনই ২৬-দরজা এক-দেহ।</div></div><ul class="checklist"><li>নিজের এক-ক্লিক-ফ্লো আঁকো: বাটন→ইভেন্ট→স্টোর→সার্ভিস→SSE→পর্দা — স্তর-নাম সহ</li><li>যেকোনো-এক স্টার্টার বিনা-নোটে আবার বানাও — ৭ দিনের চ্যালেঞ্জ</li><li>নিজের তাবিজ-খাতা লেখো: প্রতিটি দরজার ১-লাইন — নিজের ভাষায়, মুখস্থ নয়</li></ul>
