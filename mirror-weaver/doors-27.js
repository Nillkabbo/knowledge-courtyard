...
doors.push({
  ...
  <div class="dialogue">তুমি পূর্ণ-তাঁতের সামনে দাঁড়িয়ে জিজ্ঞেস করলে, "আপা, ২৬টি দরজার সব-তাবিজ মুখস্থ হয়ে গেল — এবার কী?" জোহরা আপা শেষ-সুতোটা কেটে বললেন, "মুখস্থ হলো তালিকা; হাতে-ধরা হয়নি। এই তাঁতে এক-ক্লিকের-যাত্রা দেখেছ — এখন নিজের-হাতে বাঁধ: বাটনে চাপ → ইভেন্ট-পাখি উড়লো (D5) → স্টোর-কোষাগার খুললো (D10) → সার্ভিস-দূত সমুদ্রে নামলো (D15) → ঘণ্টি-বাহক খবর ফিরিয়ে আনলো (D18) → পর্দা নিজে-নিজে বুনে উঠলো (D1)। এই সূত্রটা টানতে পারলে তুমি কারিগর; না-পারলে ২৬-দরজার-মালিক-অধ্যায়ী, কারিগর নয়। আর কারিগরের শপথ: শিখেছি মানে বানাতে-পারি — পরের সপ্তাহে একটা স্টার্টার বিনা-নোটে আবার বোনো।"</div>
<div class="dialogue en">You stood before the full loom: "Sister, all 26 amulets memorized — now what?" Johra cut the final thread: "Memorized is a list; held-by-hand is not. You watched the one-click journey on this loom — now bind it yourself: button pressed → the event-bird flew (D5) → the store-vault opened (D10) → the service-courier took to sea (D15) → the bell-carrier brought news home (D18) → the screen wove itself (D1). Pull this thread and you are a craftsman; fail, and you own 26 chapters, not a craft. And the craftsman's oath: to have learned is to be able to build — next week, re-weave one starter without notes."</div>
  <div class="compare"><div class="cmp-card cmp-bad"><div class="cmp-label">❌ তালিকা-মুখস্থ</div>২৬টি তাবিজ পড়ে "সব-জানা" ঘোষণা — হাতে-না-ধরা যন্ত্র মরীচিকা; প্রজেক্টে প্রথম-সপ্তাহেই কাশি।</div><div class="cmp-card cmp-good"><div class="cmp-label">✅ পূর্ণ-তাঁত-পরীক্ষা</div>এক-ক্লিকের-যাত্রা নিজে-বানানো — প্রতিটি স্তরে হাত রাখা; তখনই ২৬-দরজা এক-দেহ।</div></div>
...
নতুন-প্রজেক্টের-প্রথম-সপ্তাহ (স্মৃতি-সূত্র):
  ...
  <ul class="checklist"><li>নিজের এক-ক্লিক-ফ্লো আঁকো: বাটন→ইভেন্ট→স্টোর→সার্ভিস→SSE→পর্দা — স্তর-নাম সহ</li><li>যেকোনো-এক স্টার্টার বিনা-নোটে আবার বানাও — ৭ দিনের চ্যালেঞ্জ</li><li>নিজের তাবিজ-খাতা লেখো: প্রতিটি দরজার ১-লাইন — নিজের ভাষায়, মুখস্থ নয়</li></ul>
  <div class="callout tip"><span class="co-icon">📚</span><div><strong>আরও পড়া:</strong> Book 28 (Knowledge Web — ক্যাপস্টোন) সব-দরজা-এক-বুননের শিল্প — এই পূর্ণ-তাঁতের আত্মার বই; আর Book 5 (Seed of Learning) যাত্রার-পরের অভ্যাস।</div></div>
...
describe('পূর্ণ-তাঁত · এক-ক্লিকের-যাত্রা', () =&gt; {
  ...
  senior: {
    ...
    body: `<p><strong>উল্লম্ব-সুতো</strong>: @click→useMutationAction(গার্ড)→store→service(CSRF)→ফেজ-প্রয়োজনে(১৭)→টোস্ট→রিফেচ — গার্ডড-রুটে-প্রবেশ, DOM-অছুঁয়ে। <strong>২৬-তাবিজ</strong>: ভিত্তি(১-৩)·কম্পোনেন্ট(৪-৯)·অবস্থা(১০-১২)·পথ(১৩-১৫)·ফর্ম(১৬-১৮)·যন্ত্র(১৯-২১)·স্টার্টার(২২-২৬)। <strong>প্রথম-সপ্তাহ</strong>: ১৯→১৫+১০→১৩+১৪→২৩→২০+২১→২৪+১৮→বিশ্রাম। <strong>স্থাপত্য</strong>: features-স্লাইস+shared/app/ui/core। <strong>সত্য-উৎস</strong>: Vue 3.5-গাইড+LP-প্রোডাকশন। <strong>ফাঁদ</strong>: সংশ্লেষ-দরজা পড়ে "সব বুঝেছি" ভাবা — ২৬টি তাবিজ মুখস্থ-তালিকা নয়, প্রতিটি ছোট প্রজেক্টে হাতে ধরার চ্যালেঞ্জ; পরের সপ্তাহে একটা স্টার্টার আবার বানাও — নিজের হাতে।</p>`
  }
});
