...
নিয়ম-ছক:
  ...
  <div class="compare"><div class="cmp-card cmp-bad"><div class="cmp-label">❌ কপি-পেস্ট যুক্তি</div>ফেচ-লোডিং-এরর তিন-লাইন প্রতি পর্দায় নতুন — বাগ পেলে দশ জায়গায় মেরামত।</div><div class="cmp-card cmp-good"><div class="cmp-label">✅ যন্ত্রপাতি-তাবিজ</div>এক-বার লেখা composable (useFetch) — সবাই ডাকে, বাগ-ফিক্স এক জায়গায়।</div></div><ul class="checklist"><li>useFetch লেখো: loading/error/data + অপশন-ইনপুট; দুই পর্দায় পুনর্ব্যবহার</li><li>নামকরণ-নিয়ম প্রয়োগ: use* প্রিফিক্স, রিটার্ন-অবজেক্ট — নিজের তাবিজ-তালিকা শুরু করো</li><li>লেজারপাইলট-কোড থেকে একটা পুনরাবৃত্ত-যুক্তি খুঁজে composable-খসড়া লেখো</li></ul>
