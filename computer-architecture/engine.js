// ══════════════════════════════════════
// Book 42 · Computer Architecture — Engine
// ══════════════════════════════════════
let state = { xp:0, currentDoor:null, completedDoors:[], prologueSeen:false };
const XP_PER_DOOR = 100;
const SAVE_KEY = 'computerArchitecture_v1';
const MAX_XP = 1000;
const RANKS = [
  {min:0,   name:'সন্ধানী',         icon:'🔍'},
  {min:100, name:'লজিক কারিগর',    icon:'⚡'},
  {min:200, name:'পাইপলাইন যোদ্ধা',  icon:'🔧'},
  {min:300, name:'ক্যাশ রক্ষক',      icon:'🛡️'},
  {min:400, name:'সমান্তরাল মাস্টার', icon:'🧵'},
  {min:500, name:'সিলিকন স্থপতি',    icon:'🏗️'},
  {min:600, name:'অ্যাক্সেলারেটর গুরু',icon:'🚀'},
  {min:700, name:'ক্লকওয়ার্ক ঋষি',   icon:'🧭'}
];
