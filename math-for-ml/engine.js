...
const SAVE_KEY = 'mathForML_v1';
const MAX_XP = 1000;
const RANKS = [
  {min:0,   name:'ছাত্র',           icon:'🧭'},
  {min:100, name:'গণিতজ্ঞ',       icon:'📐'},
  {min:200, name:'বীজগণিতজ্ঞ',     icon:'📏'},
  {min:300, name:'ক্যালকুলাস কারিগর', icon:'∇'},
  {min:400, name:'স্থানিক চিন্তাবিদ',  icon:'🗺️'},
  {min:500, name:'অনুকূলকারী',     icon:'⚖️'},
  {min:600, name:'গাণিতিক স্থপতি',   icon:'🏛️'},
  {min:700, name:'নিকোবর ধারক',     icon:'🧭'}
];
