...
doors.push({
  ...
  <div class="callout tip"><span class="co-icon">🎯</span><div><strong>কেন কাজ করে — The Science (brief):</strong> BJ Fogg (Stanford, ২০০৯) প্রমাণ করেছেন — আচরণ ঘটে যখন Motivation × Ability × Prompt একসাথে মেলে (B=MAP)। কাজ যত ছোট, Ability তত বেশি — মানে Motivation কম থাকলেও কাজ হয়ে যায়। Stephen Guise (২০১৩) একটা পুশআপ দিয়ে শুরু করেছিলেন — এখন প্রতিদিন ৩০ মিনিট ব্যায়াম করেন। James Clear (২০১৮) একে বলেন '2-Minute Rule।' আর ২১ দিনে অভ্যাস হয় — সেটা ভুল। Lally et al. (UCL, ২০১০) দেখিয়েছেন মধ্যমা ৬৬ দিন (সীমা ১৮-২৫৪ দিন)।</div></div>
...
doors.push({
  ...
  <p class="scene-setting">এখন শোনো <strong>কারিগর জয়ন্তের</strong> গল্প। জয়ন্ত একজন বারিস্টার — কিন্তু তার ডান হাতের কনুইয়ের বাইরে একটা পুরোনো পোড়া দাগ। সে একসময় রান্নাঘরে কাজ করতো, তেল ছিটকে পুড়ে গিয়েছিল। এখন সে প্রতিদিন শত শত কাপ কফি বানায় — হাত একদম স্থির।</p>
  <div class="dialogue">
    <p><strong>শিক্ষা (নতুন বয়নি, কাঁপা হাতে):</strong> জয়ন্ত ভাই, আমার হাত কাঁপছে। ল্যাটে আর্ট হবে না। আমি পারবো না।</p>
    <p><strong>জয়ন্ত (শান্ত গলায়):</strong> হাত কাঁপছে কারণ তুই ভাবছিস তুই পারবি না। আগে শরীরটা থামা। পিঠ সোজা কর। দুই হাত নিজের কোমরে রাখ। এটাকে আমি বলি 'প্রস্তুতির ভঙ্গি।'</p>
    <p><strong>শিক্ষা (পিঠ সোজা করে):</strong> একটু... একটু ভালো লাগছে। কিন্তু হাত তো এখনো কাঁপছে।</p>
    <p><strong>জয়ন্ত:</strong> এবার চোখ বন্ধ কর। মনে কর — গত সপ্তাহে তুই প্রথম এসপ্রেসো বানালি। স্বাদ একদম ঠিক ছিল। আমি বলেছিলাম — 'এটা ভালো।' মনে আছে?</p>
    <p><strong>শিক্ষা (চোখ বন্ধ, হাসছে):</strong> হ্যাঁ... মনে আছে। সেদিন আমি ভালো করেছিলাম।</p>
    <p><strong>জয়ন্ত:</strong> হাত কাঁপছে এখন?</p>
    <p><strong>শিক্ষা (চোখ খুলে, অবাক):</strong> ...না! হাত থেমে গেছে!</p>
    <p><strong>জয়ন্ত:</strong> তুই নিজের শরীরকে বলে দিলি — 'আমি পারি।' শরীর বিশ্বাস করলো। এটাই আত্মবিশ্বাস। কোনো জাদু নেই — শুধু ভঙ্গি আর স্মৃতি।</p>
  </div>
  <p class="scene-setting">জয়ন্ত যা শিখালো, সেটা বিজ্ঞান দুইভাবে নিশ্চিত করেছে — একটা সত্যি, একটা ভুল। চলো দুটোই দেখি, সততার সাথে।</p>
  ...
  <div class="callout tip"><span class="co-icon">🎯</span><div><strong>কেন কাজ করে — The Science:</strong> Carney, Cuddy & Yap (২০১০) প্রথম দাবি করেছিলেন শক্তির ভঙ্গি হরমোন বদলায়। কিন্তু Ranehill et al. (২০১৫, Psychological Science) বড় স্যাম্পলে (N=২০০+) দেখান — <strong>হরমোনে কোনো পরিবর্তন নেই</strong>, কিন্তু 'নিজেকে শক্তিশালী মনে হওয়া' এই ফলাফলটি রেপ্লিকেট হয়েছে। Smith & Apicella (২০১৭) এটাই নিশ্চিত করেছেন। শরীর→মন সংযোগ সত্যি, কিন্তু জাদু নয়। আর Balban et al. (২০২৩, Cell Reports Medicine) প্রমাণ করেছেন cyclic sighing (double inhale, long exhale) mindfulness-এর চেয়ে ভালো কাজ করে।</div></div>
  <div class="compare">
  ...
  <div class="callout info"><span class="co-icon">🧠</span><div><strong>পবিত্র সমতুল্য — Sacred Analogue:</strong> নবী ﷺ যখন মক্কা বিজয়ের দিন কাবার দিকে তাকালেন, তাঁর চাল ছিল সগৌরবে — উটের উপর বসে, মাথা নত না করে, পুরো শহরের দিকে। সাহাবীরা বলেছেন — 'তিনি এমনভাবে প্রবেশ করলেন যেন বিজয়ী, কিন্তু বিনয়ী।' এটাই ইয়াকিন — অন্তর্দৃষ্টি থেকে উঠা নিশ্চয়তা। ভঙ্গি বাইরে, বিশ্বাস ভেতরে। নবী ﷺ বলেছেন: <em>'শক্তি বিশ্বাসীর গহনা।'</em> — মুসলিম। ক্ষমতার ভঙ্গি নয় — বিশ্বাসের ভঙ্গি।</div></div>
  <div class="verse">"নিশ্চয়ই তোমাদের ওপর বিজয় নেমে আসবে — যদি তোমরা বিশ্বাসী হও।" — কুরআন ৩৭:১৭৩</div>
  <div class="verse en">"And indeed, victory will be yours — if you are believers." — Quran 37:173</div>
  <div class="checklist">
...
doors.push({
  ...
  <div class="code-block">
    ...
    <table class="kv-table">
      ...
      <tr><td class="hl">প্রিয় পডকাস্ট</td><td class="hl">ডিশ ধোোা</td><td class="hl">পডকাস্ট শুধু ডিশ ধোওয়ার সময়</td></tr>
