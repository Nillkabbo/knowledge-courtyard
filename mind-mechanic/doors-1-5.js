...
doors.push({
  ...
  <div class="callout warn"><span class="co-icon">⚠️</span><div><strong>ভুল প্রশ্ন:</strong> 'আমি কীভাবে পড়ার ইচ্ছা জাগাবো?' <strong>সঠিক প্রশ্ন:</strong> 'আমি কীভাবে শুরুটা এত ছোট করবো যে মস্তিষ্ক প্রতিরোধ করতেই পারে না?'</div></div></div>
  ...
  <div class="verse">"আমি একে ধীরে ধীরে অবতীর্ণ করেছি, যাতে তুমি মানুষের কাছে ক্রমে ক্রমে পড়ে শোনাতে পারো।" — কুরআন ১৭:১০৬</div></div>
  <div class="verse en">"And We revealed it in portions, so that you may recite it to the people over a long period." — Quran 17:106</div></div>
  ...
  <div class="diagram">
    ...
    <div class="diag-cap">বড় কাজ মস্তিষ্ককে ভয় দেখায়; ছোট কাজ হাসায়। হাসলেই শুরু।</div></div>
  </div></div>
  <div class="secret-box">
    <div class="secret-icon">🧵</div></div>
    <div class="secret-line">একটা সুতো বোনো — কার্পেট নিজে হয়ে যাবে।</div></div>
    <div class="secret-why">কারণ মস্তিষ্ক বড় কাজকে ভয় পায়, ছোট কাজকে হাসে। হাসলেই শুরু হয়। শুরু হলেই চলতে থাকে।</div></div>
  </div>`,
  senior: {
...
doors.push({
  ...
  <div class="callout warn"><span class="co-icon">⚠️</span><div><strong>ভুল ধারণা:</strong> 'আমার ইচ্ছাশক্তি কম।' <strong>সত্য:</strong> ইচ্ছাশক্তি একটা ক্লান্তিশীল সম্পদ — দিনে সীমিত পরিমাণে থাকে। এটাকে ভরসা করলে তুমি দিন শেষে হারাবে।</div></div></div>
  ...
  <div class="compare">
    <div class="cmp-card cmp-bad"><div class="cmp-label">❌ ভুল উপায়</div>ফোন হাতে নিয়ে বলো — 'এবার পড়তে হবে, ফোন দেখবো না।' দশ মিনিট পর ফোনে ইউটিউব।</div></div>
    <div class="cmp-card cmp-good"><div class="cmp-label">✅ সঠিক উপায়</div>ফোন অন্য ঘরে রাখো। বইটা টেবিলে খোলা রাখো। যখন পড়তে বসো, ফোন নাগালের বাইরে। মস্তিষ্কের কাছে ফোন দেখার চেয়ে পড়াই সহজ মনে হয়।</div></div>
  </div></div>
  ...
  <div class="stat-grid">
    <div class="stat-card"><div class="sc-num">৪৩%</div><div class="sc-label">দৈনন্দিন আচরণ স্বয়ংক্রিয়<br>Wood et al. (2002)</div></div></div>
    <div class="stat-card"><div class="sc-num">২০ সেকেন্ড</div><div class="sc-label">ফ্রিকশনের নিয়ম — ২০ সেকেন্ড বেশি লাগলে মস্তিষ্ক ছাড়ে</div></div></div>
  </div></div>
  <div class="callout info"><span class="co-icon">🧠</span><div><strong>পবিত্র সমতুল্য — Sacred Analogue:</strong> মক্কা বিজয়ের পর নবী ﷺ ৩৬০টা মূর্তি ভাঙলেন কাবা থেকে। তিনি মানুষকে বললেন না — 'মূর্তি পূজা করবে না।' তিনি পরিবেশটাই বদলে দিলেন। মূর্তি নেই, তাই পূজাও নেই। মদের দোকান ভাঙলেন — মদ নেই, তাই পানও নেই। এটাই ফিতনা থেকে বিচ্ছিন্নতা — খারাপ কাজের উৎসটাকেই পরিবেশ থেকে সরিয়ে ফেলো। নবী ﷺ বলেছেন: <em>'পাঁচটার আগে পাঁচটাকে গনিমত (সুযোগ) মনে করো — বার্ধক্যের আগে যৌবন, রোগের আগে সুস্থতা, দারিদ্র্যের আগে সচ্ছলতা, ব্যস্ততার আগে অবসর, আর মৃত্যুর আগে জীবন।'</em> — হাকিম, আলবানি কর্তৃক সহিহ। পরিবেশ ও সময় — দুটোই বদলে যায়। যখন সুযোগ আছে, তখনই কাজে লাগাও।</div></div></div>
  <div class="verse">"হে মুমিনগণ, তোমরা আল্লাহকে ভয় করো, আর প্রত্যেকে খেয়াল করো আগামীকালের জন্য কী প্রেরণ করেছ।" — কুরআন ৫৯:১৮</div></div>
  <div class="verse en">"O you who believe, fear Allah, and let every soul look to what it has sent forth for tomorrow." — Quran 59:18</div></div>
  <div class="checklist">
  ...
  <div class="diagram">
    ...
    <div class="diag-cap">ইচ্ছাশক্তি লড়াই করো না — পথ সাজাও, মস্তিষ্ক নিজে চলে।</div></div>
  </div></div>
  <div class="secret-box">
    <div class="secret-icon">🏠</div></div>
    <div class="secret-line">পরিবেশ সাজাও — মস্তিষ্ক নিজে থেকে সঠিক পথে চলবে।</div></div>
    <div class="secret-why">কারণ ~৪৩% আচরণ স্বয়ংক্রিয়। ইচ্ছাশক্তি দিয়ে লড়াই করে হারবে। পরিবেশ বদলালে জিতবে — কোনো লড়াই ছাড়াই।</div></div>
  </div>`,
  senior: {
...
doors.push({
  ...
  <div class="callout tip"><span class="co-icon">🎯</span><div><strong>কেন কাজ করে — The Science:</strong> Carney, Cuddy & Yap (২০১০) প্রথম দাবি করেছিলেন শক্তির ভঙ্গি হরমোন বদলায়। কিন্তু Ranehill et al. (২০১৫, Psychological Science) বড় স্যাম্পলে (N=২০০+) দেখান — <strong>হরমোনে কোনো পরিবর্তন নেই</strong>, কিন্তু 'নিজেকে শক্তিশালী মনে হওয়া' এই ফলাফলটি রেপ্লিকেট হয়েছে। Smith & Apicella (২০১৭, Hormones and Behavior) আরও বড় স্যাম্পলে (N=247) এই ফলাফলটিও রেপ্লিকেট করতে পারেননি — power posing-এর বিষয়টি সম্পূর্ণভাবে বিতর্কিত। শরীর→মন সংযোগ সত্যি, কিন্তু জাদু নয়। আর Balban et al. (২০২৩, Cell Reports Medicine) প্রমাণ করেছেন cyclic sighing (double inhale, long exhale) mindfulness-এর চেয়ে ভালো কাজ করে।</div></div></div>
  <div class="compare">
    <div class="cmp-card cmp-bad"><div class="cmp-label">❌ যা ভুল প্রমাণিত</div>Power pose করলে টেস্টোস্টেরন ১৯% বাড়বে, কর্টিসল ২৫% কমবে। — Carney/Cuddy/Yap ২০১০ দাবি, Ranehill ২০১৫-এ রেপ্লিকেশন ব্যর্থ। Carney নিজে প্রত্যাখ্যান করেছেন।</div></div>
    <div class="cmp-card cmp-good"><div class="cmp-label">✅ যা সত্যি</div>সোজা পিঠ, উন্মুক্ত ভঙ্গি, অতীত জয়ের স্মৃতি, এবং physiological sigh — এগুলো নিজেকে শক্তিশালী অনুভব করায়, শরীর শান্ত করে, এবং ফোকাস বাড়ায়। হরমোন জাদু নয় — অনুভূতির বাস্তবতা।</div></div>
  </div></div>
  ...
  <div class="verse">"নিশ্চয়ই আমাদের সৈন্যরাই বিজয়ী।" — কুরআন ৩৭:১৭৩</div></div>
  <div class="verse en">"And indeed, Our soldiers — it is they who overcome." — Quran 37:173</div></div>
  <div class="checklist">
  ...
  <div class="diagram">
    ...
    <div class="diag-cap">তিন সুইচ · ৯০ সেকেন্ড · শরীর মনকে বলে কে তুমি।</div></div>
  </div></div>
  <div class="secret-box">
    <div class="secret-icon">⚡</div></div>
    <div class="secret-line">পিঠ সোজা, অতীত জয় স্মরণ, শ্বাস ছাড়ো — আত্মবিশ্বাস আসবে।</div></div>
    <div class="secret-why">কারণ শরীর মনকে বলে কে তুমি। ভঙ্গি বদলালে অনুভূতি বদলায়। অতীত সফলতা মস্তিষ্ককে সেই state-এ ফিরিয়ে নিয়ে যায়। এটা হরমোন নয় — এটা তোমার নিজের স্মৃতির শক্তি।</div></div>
  </div>`,
  senior: {
...
doors.push({
  ...
  <div class="callout warn"><span class="co-icon">⚠️</span><div><strong>ভুল কৌশল:</strong> 'আমি পড়ার পর সিরিজ দেখবো।' কেন ভুল? কারণ ডোপামিন প্রত্যাশায় কাজ করে — তুমি সিরিজের প্রত্যাশায় পড়তে বসলে ভালো লাগে। কিন্তু পড়ার প্রত্যাশায় সিরিজ দেখলে — সিরিজটাই প্রিয় হয়ে যায়, পড়াটা শাস্তির মতো মনে হয়।</div></div></div>
  ...
  <div class="callout tip"><span class="co-icon">🎯</span><div><strong>কেন কাজ করে — The Science:</strong> <strong>Wolfram Schultz</strong> (Cambridge, ১৯৯৭, <em>Science</em>) মাকাক বানরের ডোপামিন নিউরন রেকর্ড করে দেখিয়েছেন — ডোপামিন পুরস্কারে ফায়ার করে না, <strong>পুরস্কারের সংকেতে (cue)</strong> ফায়ার করে। যখন বাতি জ্বলে যে খাবার আসবে — তখনই ডোপামিন বাড়ে। খাবার মুখে পৌঁছালে ডোপামিন স্থির হয়ে যায়। আর যদি বাতি জ্বলে কিন্তু খাবার না আসে — ডোপামিন <em>বেসলাইনের নিচে</em> নেমে যায়। এটাই <strong>Reward Prediction Error (RPE)</strong>। Robert Sapolsky (Stanford, ২০১৭, <em>Behave</em>) এটা ব্যাখ্যা করেছেন: ডোপামিন প্রত্যাশায় সবচেয়ে বেশি, নিশ্চয়তায় কম, হতাশায় নিচে। Katy Milkman (Wharton, ২০১৪, <em>Management Science</em>) দেখিয়েছেন — অডিওবুক শুধু জিমে শুনলে <strong>ব্যায়াম ৫১% বেশি</strong> হয়।</div></div></div>
  <div class="stat-grid">
    <div class="stat-card"><div class="sc-num">৫১%</div><div class="sc-label">ব্যায়াম বেড়েছে temptation bundling-এ<br>Milkman et al. (2014)</div></div></div>
    <div class="stat-card"><div class="sc-num">RPE</div><div class="sc-label">Reward Prediction Error — ডোপামিনের আসল সূত্র<br>Schultz et al. (1997)</div></div></div>
  </div></div>
  <div class="compare">
    <div class="cmp-card cmp-bad"><div class="cmp-label">❌ ভুল উপায়</div>'পড়ার পর সিরিজ দেখবো।' ডোপামিন সিরিজের প্রত্যাশায় পড়াকে কষ্টের মতো করে তোলে। সিরিজ পুরস্কার, পড়া শাস্তি।</div></div>
    <div class="cmp-card cmp-good"><div class="cmp-label">✅ সঠিক উপায়</div>'অডিওবুক শুধু জিমে শুনবো।' ডোপামিন অডিওবুকের প্রত্যাশায় ব্যায়ামকে আনন্দদায়ক করে তোলে। অডিওবুক বাঁধাই, ব্যায়াম স্বয়ংক্রিয়।</div></div>
  </div></div>
  <div class="callout info"><span class="co-icon">🧠</span><div><strong>পবিত্র সমতুল্য — Sacred Analogue:</strong> রমজানের রোজা কী? একটা temptation bundle। পানাহার — যা মানুষ সবচেয়ে বেশি ভালোবাসে — সেটা শুধু সূর্যাস্তের পরে। সারা দিন প্রত্যাশা তৈরি হয় — ডোপামিন বাড়ে। আর ইফতারির সময় যখন খেজুর মুখে যায় — সেই তৃপ্তি অন্য কোনো সময় নেই। কারণ প্রত্যাশা দীর্ঘ ছিল। এটাই নিয়ামত — আনন্দকে উপাসনা না করে, কাজে লাগানো। ডোপামিন যদি তোমাকে নিয়ন্ত্রণ করে, তুমি তার দাস। কিন্তু তুমি যদি ডোপামিনকে নিয়ন্ত্রণ করো — সে তোমার কারিগর।</div></div></div>
  <div class="verse">"তোমাদের জন্য রোজা নির্ধারিত হলো — যেন তোমরা ধর্মপরায়ণ হও।" — কুরআন ২:১৮৩</div></div>
  <div class="verse en">"Fasting is prescribed for you, so that you may become righteous." — Quran 2:183</div></div>
  <div class="checklist">
  ...
  <div class="diagram">
    ...
    <div class="diag-cap">ডোপামিন পুরস্কারে আসে না — প্রত্যাশায় আসে (Schultz 1997)।</div></div>
  </div></div>
  <div class="secret-box">
    <div class="secret-icon">🧪</div></div>
    <div class="secret-line">আনন্দকে কাজের সাথে বাঁধো — মস্তিষ্ক নিজে থেকে কাজ চাইবে।</div></div>
    <div class="secret-why">কারণ ডোপামিন প্রত্যাশায় আসে, পুরস্কারে নয়। তুমি প্রত্যাশা তৈরি করো — মস্তিষ্ক কাজটাকে আনন্দ ভেবে শুরু করে দেয়। তুমি জোর করো না — ডোপামিন তোমাকে টানে।</div></div>
  </div>`,
  senior: {
...
doors.push({
  ...
  <div class="callout warn"><span class="co-icon">⚠️</span><div><strong>সমস্যা:</strong> তুমি মস্তিষ্ককে বলে শান্ত করতে পারবে না — কারণ মস্তিষ্কই তো ভয়ে আছে। তোমাকে <strong>শরীরের</strong> ভাষায় কথা বলতে হবে। আর শরীরের ভাষা হলো — শ্বাস।</div></div></div>
  ...
  <div class="verse">"শপথ সেই আত্মার এবং যিনি তাকে সুবিন্যস্ত করেছেন। তারপর তাকে তার অশুভতা ও তার পবিত্রতা অনুপ্রাণিত করেছেন।" — কুরআন ৯১:৭-৮</div></div>
  <div class="verse en">"By the soul and He who proportioned it, and inspired it with its wickedness and its righteousness." — Quran 91:7-8</div></div>
  <div class="checklist">
  ...
  <div class="diagram">
    ...
    <div class="diag-cap">দুই ভরো, এক ছাড়ো — স্নায়ুতন্ত্র শান্ত মোডে যায়।</div></div>
  </div></div>
  <div class="secret-box">
    <div class="secret-icon">🌬️</div></div>
    <div class="secret-line">শ্বাস হলো শরীরের রিমোট কন্ট্রোল — দুই ভরো, এক ছাড়ো।</div></div>
    <div class="secret-why">কারণ শ্বাস একমাত্র স্বয়ংক্রিয় সিস্টেম যা তুমি চাইলে ম্যানুয়ালি নিয়ন্ত্রণ করতে পারো। লম্বা নিঃশ্বাস ভাগাস নার্ভ চালু করে — শরীরের শান্তি মোড। কোনো খরচ নেই, কোনো পার্শ্বপ্রতিক্রিয়া নেই — শুধু তোমার নিজের শ্বাস।</div></div>
  </div>`,
  senior: {
