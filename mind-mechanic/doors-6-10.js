...
doors.push({
  ...
  <div class="stat-grid">
    <div class="stat-card"><div class="sc-num">~১০,০০০ lux</div><div class="sc-label">বাইরের আলো (মেঘলা দিনেও)<br>vs ঘরের ~৩০০ lux</div></div>
  ...
  <div class="compare">
    <div class="cmp-card cmp-bad"><div class="cmp-label">❌ ভুল উপায়</div>সকালে ফোন চেক করো, পর্দা বন্ধ। রাতে উজ্জ্বল আলো, ল্যাপটপ দেখো ঘুমানোর আগে। কফি দিয়ে এনার্জি চাও।</div>
...
doors.push({
  ...
  <div class="stat-grid">
    <div class="stat-card"><div class="sc-num">~৪৭%</div><div class="sc-label">জাগ্রত সময়ে মন পথভ্রষ্ট<br>Killingsworth & Gilbert (2010)</div></div>
  ...
  <div class="compare">
    <div class="cmp-card cmp-bad"><div class="cmp-label">❌ ভুল উপায়</div>৫টা ট্যাব খোলা। পড়ার সময় ফোন হাতে। মন গেলে রেগে হো। 'আমি পারছি না!' বলে ছেড়ে দাও।</div>
...
doors.push({
  ...
  <div class="compare">
    <div class="cmp-card cmp-bad"><div class="cmp-label">❌ ভুল উপায়</div>পরীক্ষার আগের রাত জাগো। চা খাও। সকালে মনে রাখার চেষ্টা করো। ফাইল খোলো — খালি।</div>
...
doors.push({
  ...
  <div class="stat-grid">
    <div class="stat-card"><div class="sc-num">৬৬ দিন</div><div class="sc-label">অভ্যাস স্বয়ংক্রিয় হতে মধ্যমা (১৮-২৫৪)<br>Lally et al. (2010, UCL)</div></div>
  ...
  <div class="compare">
    <div class="cmp-card cmp-bad"><div class="cmp-label">❌ ভুল উপায়</div>'আমি আর ফোন সকালে দেখবো না।' শুধু রুটিন ভাঙছো — কিউ আর রিওয়ার্ড বেঁচে আছে। মস্তিষ্ক তোমাকে আবার ফোনের দিকে ঠেলে দেবে।</div>
...
doors.push({
  ...
  <div class="stat-grid">
    <div class="stat-card"><div class="sc-num">৩ স্তর</div><div class="sc-label">লক্ষ্য → প্রক্রিয়া → পরিচয়<br>Clear (2018, Atomic Habits)</div></div>
  ...
  <div class="compare">
    <div class="cmp-card cmp-bad"><div class="cmp-label">❌ লক্ষ্য-ভিত্তিক</div>'আমি ১০ কেজি কমাবো।' লক্ষ্য পূরণ হলে বা ব্যর্থ হলে — কাজ থেমে যায়। কারণ কাজের কারণ ছিল লক্ষ্য, লক্ষ্য গেলে কারণ শেষ।</div>
