...
doors.push({
  ...
  <div class="code-block">
    ...
    <p><strong>সুইচ ২ — ঠান্ঠা পানি (Cold Exposure):</strong> গোসলের শেষে ৩০-৬০ সেকেন্ড ঠান্ঠা পানি (ঠান্ঠা = অস্বস্তি কিন্তু সহ্য করা যায়)।</p>
    <p>ঠান্ঠা পানিতে ডোপামিন বেসলাইন ~২৫০% বাড়ে, নরঅ্যাড্রেনালিন ~৫৩০% বাড়ে — এবং এই বৃদ্ধি ঘণ্টার পর ঘণ্টা স্থায়ী হয় (Srámek et al., ২০০০)। কফির স্পাইক ৩০ মিনিটে শেষ — ঠান্ঠা পানির এনার্জি ঘণ্টায় ঘণ্টায়।</p>
  ...
  <div class="stat-grid">
    ...
    <div class="stat-card"><div class="sc-num">২৫০%</div><div class="sc-label">ডোপামিন বৃদ্ধি ঠান্ঠা পানিতে<br>Srámek et al. (2000)</div></div>
  </div>
  <div class="callout warn"><span class="co-icon">⚠️</span><div><strong>নিরাপত্তা — Safety:</strong> উইম হফ শ্বাস-ব্যায়াম পানির কাছে করবে না — মৃত্যুর ঘটনা ঘটেছে (৩২টি রিপোর্ট, মার্চ ২০২৪)। হার্টের সমস্যা থাকলে ঠান্ঠা পানি এড়াও। গর্ভবতী বা উচ্চ রক্তচাপ থাকলে চিকিৎসকের পরামর্শ নাও। ঠান্ঠা পানি শুরু করো ধীরে — প্রথমে ১৫ সেকেন্ড, তারপর বাড়াও।</div></div>
  <div class="compare">
    ...
    <div class="cmp-card cmp-good"><div class="cmp-label">✅ সঠিক উপায়</div>সকালে বাইরে যাও — ৫ মিনিট আকাশের দিকে তাকাও। গোসলের শেষে ৩০ সেকেন্ড ঠান্ঠা পানি। রাতে ডিম লাইট, কোনো স্ক্রিন নয়।</div>
  </div>
  ...
  <div class="checklist">
    ...
    <li>গোসলের শেষে ৩০ সেকেন্ড ঠান্ঠা পানি</li>
  ...
  <div class="secret-box">
    ...
    <div class="secret-line">সকালের আলো ঘড়ি সেট করে, ঠান্ঠা পানি ব্যাটারি চার্জ করে।</div>
    <div class="secret-why">কারণ মেলানোপসিন কোষ শুধু বাইরের নীল আলোতে জেগে ওঠে। আর ঠান্ঠা পানি ডোপামিন ও নরঅ্যাড্রেনালিন ঘণ্টার পর ঘণ্টা বাড়িয়ে রাখে। কোনো খরচ নেই — শুধু বাইরে যাও আর ঠান্ঠা পানি সহ্য করো।</div>
  </div>`,
  senior: {
    title: "আগামীকাল সকালে করো — Tomorrow Morning",
    body: "<p>আগামীকাল সকালে এই ৩টি করো:<br><strong>১.</strong> ঘুম থেকে উঠেই বাইরে যাও — ৫ মিনিট আকাশের দিকে তাকাও।<br><strong>২.</strong> গোসলের শেষে ৩০ সেকেন্ড ঠান্ঠা পানি নাও (যদি সহ্য হয়)।<br><strong>৩.</strong> সন্ধ্যায় ফোনের নাইট মোড চালু করো।<br><br>এক সপ্তাহ এই তিনটা করো। তুমি নিজেই পার্থক্য টের পাবে — দুপুরের ক্লান্তি কমবে, রাতের ঘুম ভালো হবে। এটা জাদু নয় — এটা তোমার মাস্টার ক্লক সঠিকভাবে চলছে।</p>"
  }
});
...
doors.push({
  ...
  <div class="callout tip"><span class="co-icon">🎯</span><div><strong>কেন কাজ করে — The Science:</strong> <strong>Amishi Jha</strong> (University of Miami) ও সহযোগীরা ২০১০ সালে <em>Emotion</em>-এ প্রকাশ করেছেন — মার্কিন সেনাদের উপর গবেষণা করে দেখিয়েছেন যে ৮ সপ্তাহের <strong>Mindfulness Training (MT)</strong> চাপের সময় ওয়ার্কিং মেমোরির ক্ষয় রোধ করেছে। অপ্রশিক্ষিত সেনাদের মেমোরি ক্ষয়প্রাপ্ত হয়েছিল; প্রশিক্ষিতদের সংরক্ষিত বা উন্নত হয়েছিল। বেশি প্র্যাকটিস = বেশি উন্নতি (dose-response)। Killingsworth & Gilbert (২০১০, <em>Science</em>) দেখিয়েছেন মানুষের মন <strong>জাগ্রত সময়ের ~৫০%</strong> ভবিষ্যৎ বা অতীতে ঘুরে বেড়ায় — এটাই দুঃখের প্রধান কারণ। <strong>Cal Newport</strong> (Georgetown, ২০১৬, <em>Deep Work</em>) একে বলেন <em>'ডিপ ওয়ার্ক'</em> — বিকর্ষণমুক্ত অবস্থায় জ্ঞানীয় সক্ষমতার সীমায় পৌঁছানো। তাঁর মতে চার ধরনের সময়সূচী আছে: মঠবাসী (সব বাদ), দ্বিমুখী (ঋতু অনুযায়ী), ছন্দময় (প্রতিদিন একই ব্লক), সাংবাদিক (যখন যখন সময় পাও)। সবচেয়ে কার্যকর নিয়মিতদের জন্য — <strong>ছন্দময় (rhythmic)</strong>।</div></div>
  <div class="stat-grid">
    <div class="stat-card"><div class="sc-num">~৫০%</div><div class="sc-label">জাগ্রত সময়ে মন পথভ্রষ্ট<br>Killingsworth & Gilbert (2010)</div></div>
...
doors.push({
  ...
  spirit: "নবম-ছয় — রাত ও ঘুমের নিদর্শন",
  ...
  <div class="verse">"তিনি যিনি তোমাদের জন্য রাতকে করেছেন বস্ত্র, এবং ঘুমকে করেছেন বিশ্রাম, এবং দিনকে করেছেন জীবনযাপনের।" — কুরআন ৭৮:৯-১০</div>
  <div class="verse en">"And made your sleep for rest, and made the night as a covering, and made the day for livelihood." — Quran 78:9-10</div>
  <div class="checklist">
    <li>পরীক্ষার আগের রাত কখনো জাগবে না — ঘুমাবে</li>
    <li>ঘুমানোর ১-২ ঘণ্টা আগে যা পড়ো, সেটাই সবচেয়ে ভালো মনে থাকে</li>
    <li>ঘর ঠান্ঠা রাখো (১৮-২০°C) — গোসল করে শুয়ে পড়ো</li>
...
doors.push({
  ...
  <div class="dialogue">
    ...
    <p><strong>ইসহাক:</strong> সেটাই ভুল। পানি কখনো সোজা নিচে নামে না। পানির তিনটা জিনিস লাগে — উৎস, ঢাল, গন্তব্য। উৎস থেকে ঢাল বেয়ে গন্তব্যে যায়। তুই শুধু গন্তব্য খুঁডিস — কিন্তু উৎস কোথায়? ঢাল কোথায়?</p>
