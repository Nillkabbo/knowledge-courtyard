...
doors.push({
  ...
  <div class="callout warn"><span class="co-icon">⚠️</span><div><strong>ভুল ধারণা:</strong> 'আমি যেকোনো আলোতে সকাল শুরু করতে পারি।' <strong>সত্য:</strong> তোমার চোখের ভেতরে বিশেষ কোষ আছে যারা শুধু <em>বাইরের</em> সকালের আলোতে জেগে ওঠে। ঘরের আলো, ফোনের আলো — এরা এসবে সাড়া দেয় না।</div></div></div>
  ...
  <div class="diagram">
    ...
    <div class="diag-cap">সকালের আলো ঘড়ি সেট করে; রাতের অন্ধকার ঘুম ডাকে।</div></div>
  </div></div>
  <div class="secret-box">
    <div class="secret-icon">☀️</div></div>
    <div class="secret-line">সকালের আলো ঘড়ি সেট করে, ঠান্ডা পানি ব্যাটারি চার্জ করে।</div></div>
    <div class="secret-why">কারণ মেলানোপসিন কোষ শুধু বাইরের নীল আলোতে জেগে ওঠে। আর ঠান্ডা পানি ডোপামিন ও নরঅ্যাড্রেনালিন ঘণ্টার পর ঘণ্টা বাড়িয়ে রাখে। কোনো খরচ নেই — শুধু বাইরে যাও আর ঠান্ডা পানি সহ্য করো।</div></div>
  </div>`,
  senior: {
...
doors.push({
  ...
  <div class="callout warn"><span class="co-icon">⚠️</span><div><strong>বড় ভুল:</strong> 'আমি একসাথে অনেক কিছু করতে পারি।' মস্তিষ্ক <em>কখনো</em> একসাথে দুটো জটিল কাজ করতে পারে না। যাকে তুমি 'মাল্টিটাস্কিং' বলো, সেটা আসলে <strong>টাস্ক-সুইচিং</strong> — এক কাজ থেকে অন্য কাজে দ্রুত লাফ। প্রতিটা লাফে সময় যায়, এনার্জি যায়, ভুল বাড়ে।</div></div></div>
  ...
  <div class="stat-grid">
    ...
    <div class="stat-card"><div class="sc-num">৯০ মিনিট</div><div class="sc-label">আল্ট্রাডিয়ান চক্র — প্রাকৃতিক ফোকাস ব্লক<br>Kleitman (1969)</div></div></div>
  </div></div>
  <div class="compare">
    ...
    <div class="cmp-card cmp-good"><div class="cmp-label">✅ সঠিক উপায়</div>একটা ট্যাব, ফোন অন্য ঘরে। মন গেলে ধরো — 'মন গেছে।' বিনা রাগে ফিরিয়ে আনো। প্রতিবার ফিরিয়ে আনা = একটা পুশআপ।</div></div>
  </div></div>
  <div class="callout info"><span class="co-icon">🧠</span><div><strong>পবিত্র সমতুল্য — Sacred Analogue:</strong> নামাজে দাঁড়িয়ে তুমি যখন 'আল্লাহু আকবর' বলো — সব কিছু পেছনে ফেলে দাও। শুধু একটা কিবলা, একটা কাবা, একটা মহা উপস্থিতি। এটাই খুশু — অবিভক্ত উপস্থিতি। নবী ﷺ বলেছেন: <em>'আল্লাহকে এমনভাবে ইবাদত করো যেন তুমি তাঁকে দেখছো — যদি তাঁকে দেখো না, তিনি তোমাকে দেখছেন।'</em> — মুসলিম। কিন্তু মন সরে যায় — শয়তান বলে 'পরে কি খাবে?' তুমি ধরো — 'মন গেছে।' ফিরিয়ে আনো। এক রাকাআতে কতবার? শতবার? প্রতিটা ফিরিয়ে আনা একটা আমল। নামাজ শেষ হলে তুমি শুধু আধ্যাত্মিক পুণ্য অর্জন করো না — তুমি ফোকাসের পেশী গড়ো। এজন্য নামাজের পরে মন শান্ত থাকে, কাজে মন বসে। কারণ তুমি মস্তিষ্কের পেশী ব্যায়াম করেছো।</div></div></div>
  <div class="verse">"যারা তাদের নামাজে খুশু করে, তারাই সফলকাম্য।" — কুরআন ২৩:১-২</div></div>
  <div class="verse en">"Certainly will the believers have succeeded — they who are humbly submissive in their prayers." — Quran 23:1-2</div></div>
  <div class="checklist">
  ...
  <div class="diagram">
    ...
    <div class="diag-cap">ফোকাস মানে মন না যাওয়া নয় — গেলে ফিরিয়ে আনা। প্রতিবার = একটা পুশআপ।</div></div>
  </div></div>
  <div class="secret-box">
    <div class="secret-icon">🛡️</div></div>
    <div class="secret-line">ফোকাস মানে মন না যাওয়া নয় — মন গেলে ফিরিয়ে আনা।</div></div>
    <div class="secret-why">কারণ ফোকাস একটা পেশী। মন সরে যাওয়া ধরা আর ফিরিয়ে আনাই সেই পেশীর ব্যায়াম। যত বেশি ফিরিয়ে আনবে, তত শক্ত হবে। একদিন তুমি আবিষ্কার করবে — মন আর আগের মতো সরে যায় না।</div></div>
  </div>`,
  senior: {
...
doors.push({
  ...
  <div class="callout warn"><span class="co-icon">⚠️</span><div><strong>বড় ভুল:</strong> 'যত কম ঘুমাবো, তত বেশি পড়বো।' এটা একটা আত্মঘাতী ধারণা। কারণ ঘুম হলো শেখার <em>সেভ বাটন</em>। তুমি যা পড়েছো, ঘুমের সময় সেটা হার্ডড্রাইভে সেভ হয়। না ঘুমালে — সেভ হয় না। সকালে ফাইলটা খোলো, দেখো খালি।</div></div></div>
  ...
  <div class="stat-grid">
    ...
    <div class="stat-card"><div class="sc-num">৭-৯ ঘণ্টা</div><div class="sc-label">প্রাপ্তবয়স্কদের জন্য আদর্শ ঘুম<br>National Sleep Foundation</div></div></div>
  </div></div>
  <div class="compare">
    ...
    <div class="cmp-card cmp-good"><div class="cmp-label">✅ সঠিক উপায়</div>ঘুমানোর আগে পড়ো। তারপর ঘুমাও — গভীর ঘুমে মস্তিষ্ক সেভ করে। সকালে ফাইল খোলো — ভর্তি।</div></div>
  </div></div>
  <div class="callout info"><span class="co-icon">🧠</span><div><strong>পবিত্র সমতুল্য — Sacred Analogue:</strong> কুরআনে আল্লাহ বলেছেন: <em>'তিনি তোমাদের জন্য রাতকে করেছেন বস্ত্র, এবং ঘুমকে করেছেন বিশ্রাম।'</em> (৭৮:৯-১০)। রাত = বস্ত্র — মানে আবরণ, সুরক্ষা। দিনের ক্লান্তি, তথ্য, অভিজ্ঞতা — রাতের অন্ধকারে মস্তিষ্ক সেগুলোকে গ্রহণ করে, সাজায়। নবী ﷺ বলেছেন: <em>'তোমাদের জন্য রাতের শেষ ভাগে একটা সময় আছে যে সময় আল্লাহ বান্দার দিকে তাকান — যে জাগে।'</em> তাহাজ্জুদ — শুধু আধ্যাত্মিক নয়, এটা সারকেডিয়ান। রাতের শেষ তৃতীয়াংশে REM ঘুম সবচেয়ে গভীর — যে জাগে সে মস্তিষ্কের সবচেয়ে সৃজনশীল সময়টায় আল্লাহর সাথে কথা বলে। নবী ﷺ এর দুআ: <em>'হে আল্লাহ, আমার উম্মতের জন্য সকালের বরকত দান করো।'</em> — সকালে উঠা = বরকত। কারণ সকালে ঘুম থেকে ওঠা মস্তিষ্কের প্রাকৃতিক সারকেডিয়ান শিখর।</div></div></div>
  <div class="verse">"তিনি যিনি তোমাদের জন্য রাতকে করেছেন বস্ত্র, এবং ঘুমকে করেছেন বিশ্রাম, এবং দিনকে করেছেন জীবনযাপনের।" — কুরআন ৭৮:৯-১১</div></div>
  <div class="verse en">"And made your sleep for rest, and made the night as a covering, and made the day for livelihood." — Quran 78:9-11</div></div>
  <div class="checklist">
  ...
  <div class="diagram">
    ...
    <div class="diag-cap">তুমি জেগে শেখো না — ঘুমে শেখো। ঘুম সেভ করে।</div></div>
  </div></div>
  <div class="secret-box">
    <div class="secret-icon">😴</div></div>
    <div class="secret-line">তুমি জেগে শেখো না — ঘুমে শেখো। ঘুম হলো সেভ বাটন।</div></div>
    <div class="secret-why">কারণ গভীর ঘুমের সময় হিপোক্যাম্পাস থেকে কর্টেক্সে তথ্য স্থানান্তর হয়। এক রাত না ঘুমালে নতুন স্মৃতি তৈরির ক্ষমতা কমে। যে ঘুমায় না, সে পড়াই মুছে দেয়।</div></div>
  </div>`,
  senior: {
...
doors.push({
  ...
  <div class="callout warn"><span class="co-icon">⚠️</span><div><strong>ভুল কৌশল:</strong> 'আমি আর ফোন সকালে দেখবো না।' তুমি শুধু রুটিন ভাঙতে চাইছো — কিন্তু কিউ (ঘুম থেকে ওঠা) আছে, রিওয়ার্ড (ডোপামিন) আছে। মস্তিষ্ক বলবে — 'কিউ এসেছে, রিওয়ার্ড কোথায়?' এবং তোমাকে ফোনের দিকে ধাক্কা দেবে।</div></div></div>
  ...
  <div class="stat-grid">
    ...
    <div class="stat-card"><div class="sc-num">চাঙ্কিং</div><div class="sc-label">বেসাল গ্যাংলিয়া রুটিনকে একক করে দেয়<br>Graybiel (1999, MIT)</div></div></div>
  </div></div>
  <div class="compare">
    ...
    <div class="cmp-card cmp-good"><div class="cmp-label">✅ সঠিক উপায়</div>কিউ চিনো (সকালে ওঠা)। রিওয়ার্ড চিনো (ডোপামিন)। নতুন রুটিন বসাও (বই খোলা)। একই কিউ, একই রিওয়ার্ড — নতুন রুটিন।</div></div>
  </div></div>
  <div class="callout info"><span class="co-icon">🧠</span><div><strong>পবিত্র সমতুল্য — Sacred Analogue:</strong> নবী ﷺ বলেছেন: <em>'সবচেয়ে প্রিয় আমল আল্লাহর কাছে সেটা, যেটা নিয়মিত হয় — যদিও ছোট।'</em> — বুখারি। এটা একটা অভ্যাস লুপের বিবরণ। 'নিয়মিত' মানে কিউ → রুটিন → রিওয়ার্ড লুপ প্রতিদিন চলছে। ছোট মানে রুটিন ছোট — কিন্তু লুপ শক্ত। নবী ﷺ এর নিজের জীবন ছিল অভ্যাসে ভরা — প্রতিদিন একই সময়ে নামাজ, একই দিকে ঘুমানো, একই দুআ। এটাকে বলে সুন্নাহ গঠন — পুনরাবৃত্তি মস্তিষ্কে পথ কাটে। আল্লাহ বলেছেন: <em>'নিশ্চয়ই তোমাদের জন্য রাসূলে রয়েছে উত্তম আদর্শ।'</em> (৩৩:২১) — এই আদর্শ শুধু বিশ্বাসের নয়, এটা আচরণের অভ্যাস লুপ।</div></div></div>
  <div class="verse">"নিশ্চয়ই তোমাদের জন্য রাসূলে রয়েছে আল্লাহর উত্তম আদর্শ — যারা আল্লাহ ও শেষ দিনের প্রত্যাশা করে এবং আল্লাহকে অধিক স্মরণ করে।" — কুরআন ৩৩:২১</div></div>
  <div class="verse en">"There has certainly been for you in the Messenger of Allah an excellent pattern." — Quran 33:21</div></div>
  <div class="checklist">
  ...
  <div class="diagram">
    ...
    <div class="diag-cap">তিনে মিলে অভ্যাস — একটা বাদ দিলে ভাঙে।</div></div>
  </div></div>
  <div class="secret-box">
    <div class="secret-icon">🔄</div></div>
    <div class="secret-line">কিউ-রুটিন-রিওয়ার্ড — তিনে মিলে অভ্যাস। একটা বাদ দিলে ভাঙে।</div></div>
    <div class="secret-why">কারণ বেসাল গ্যাংলিয়া পুরো রুটিনকে একটা চাঙ্কে পরিণত করে। কিউ আসলেই পুরো চাঙ্ক চলে যায়। তুমি রুটিন ভাঙলে হবে না — পুরো লুপ বদলাতে হবে। নতুন কিউ + নতুন রুটিন + নতুন রিওয়ার্ড = নতুন অভ্যাস।</div></div>
  </div>`,
  senior: {
...
doors.push({
  ...
  <div class="callout warn"><span class="co-icon">⚠️</span><div><strong>সমস্যা:</strong> লক্ষ্য একটা গন্তব্য — পৌঁছালে শেষ। কিন্তু তুমি গন্তব্যে পৌঁছে থামতে চাও না। তুমি চাও চলতে থাকে। আর চলতে থাকার জন্য লক্ষ্য যথেষ্ট নয় — <strong>পরিচয়</strong> দরকার।</div></div></div>
  ...
  <div class="stat-grid">
    ...
    <div class="stat-card"><div class="sc-num">ভোট</div><div class="sc-label">প্রতিটা কাজ একটা ভোট — তুমি কে তার জন্য<br>Self-Perception Theory (Bem, 1972)</div></div></div>
  </div></div>
  <div class="compare">
    ...
    <div class="cmp-card cmp-good"><div class="cmp-label">✅ পরিচয়-ভিত্তিক</div>'আমি সুস্থ ব্যক্তি।' সুস্থ ব্যক্তি ব্যায়াম করে — ওজন কমুক বা না কমুক। পরিচয় কখনো শেষ হয় না, তাই কাজও কখনো থামে না।</div></div>
  </div></div>
  <div class="callout info"><span class="co-icon">🧠</span><div><strong>পবিত্র সমতুল্য — Sacred Analogue:</strong> ইসলামে সবচেয়ে গুরুত্বপূর্ণ প্রশ্ন হলো — <em>'তুমি কে?'</em> জিব্রাঈল (আ) নবী ﷺ কে জিজ্ঞেস করেছিলেন: <em>'ইহসান কী?'</em> নবী ﷺ বলেছেন: <em>'আল্লাহকে এমনভাবে ইবাদত করা যেন তুমি তাঁকে দেখছো — যদি তাঁকে দেখো না, তিনি তোমাকে দেখছেন।'</em> — মুসলিম। এটা একটা পরিচয়। ইহসান কোনো লক্ষ্য নয় — এটা একটা সত্তা। তুমি মুমিন, তাই তুমি ইবাদত করো — না যে ইবাদত করলে মুমিন হবে। আল্লাহ বলেছেন: <em>'নিশ্চয়ই মুমিনরা কেবল তারাই যারা যখন আল্লাহর কথা বলা হয়, তাদের হৃদয় কম্পিত হয়।'</em> (৮:২) — এটা পরিচয়ের বিবরণ। তুমি বলো না — 'আমি নামাজ পড়বো।' তুমি বলো — 'আমি মুমিন।' মুমিন নামাজ পড়ে।</div></div></div>
  <div class="verse">"নিশ্চয়ই মুমিনরা কেবল তারাই যারা যখন আল্লাহর কথা বলা হয়, তাদের হৃদয় কম্পিত হয়, এবং যখন তাঁর আয়াতসমূহ তাদের কাছে পাঠ করা হয়, তা তাদের ঈমান বৃদ্ধি করে।" — কুরআন ৮:২</div></div>
  <div class="verse en">"The believers are only those who, when Allah is mentioned, their hearts become fearful, and when His verses are recited to them, it increases them in faith." — Quran 8:2</div></div>
  <div class="checklist">
  ...
  <div class="diagram">
    ...
    <div class="diag-cap">লক্ষ্য শেষ হয়, পরিচয় শেষ হয় না।</div></div>
  </div></div>
  <div class="secret-box">
    <div class="secret-icon">🧭</div></div>
    <div class="secret-line">লক্ষ্য বলো না কী করবে — পরিচয় বলো কে তুমি।</div></div>
    <div class="secret-why">কারণ লক্ষ্য শেষ হয়, পরিচয় শেষ হয় না। তুমি যা করো, তুমি তা হয়ে যাও — self-perception theory। প্রতিটা কাজ একটা ভোট। ভোট জমলে পরিচয় শক্ত হয়। শক্ত পরিচয় আচরণ চালায় — ইচ্ছাশক্তি ছাড়াই।</div></div>
  </div>`,
  senior: {
