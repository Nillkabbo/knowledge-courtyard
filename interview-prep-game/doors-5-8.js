...
<div class="diagram"><svg viewBox="0 0 560 220" xmlns="http://www.w3.org/2000/svg"><text x="280" y="25" text-anchor="middle" fill="#fbbf24" font-size="11" font-weight="bold">System Design: 5-Step Framework</text><rect x="20" y="45" width="100" height="50" rx="6" fill="rgba(45,212,191,.08)" stroke="#2dd4bf" stroke-width="1.5"/><text x="70" y="68" text-anchor="middle" fill="#2dd4bf" font-size="10" font-weight="bold">1. Clarify</text><text x="70" y="85" text-anchor="middle" fill="#9a93b8" font-size="9">requirements</text><rect x="130" y="45" width="100" height="50" rx="6" fill="rgba(82,196,26,.08)" stroke="#52c41a" stroke-width="1.5"/><text x="180" y="68" text-anchor="middle" fill="#52c41a" font-size="10" font-weight="bold">2. Estimate</text><text x="180" y="85" text-anchor="middle" fill="#9a93b8" font-size="9">scale QPS/storage</text><rect x="240" y="45" width="100" height="50" rx="6" fill="rgba(251,191,36,.08)" stroke="#fbbf24" stroke-width="1.5"/><text x="290" y="68" text-anchor="middle" fill="#fbbf24" font-size="10" font-weight="bold">3. API</text><text x="290" y="85" text-anchor="middle" fill="#9a93b8" font-size="9">define endpoints</text><rect x="350" y="45" width="100" height="50" rx="6" fill="rgba(167,139,250,.08)" stroke="#a78bfa" stroke-width="1.5"/><text x="400" y="68" text-anchor="middle" fill="#a78bfa" font-size="10" font-weight="bold">4. Draw</text><text x="400" y="85" text-anchor="middle" fill="#9a93b8" font-size="9">architecture</text><rect x="460" y="45" width="80" height="50" rx="6" fill="rgba(240,98,146,.08)" stroke="#f06292" stroke-width="1.5"/><text x="500" y="68" text-anchor="middle" fill="#f06292" font-size="10" font-weight="bold">5. Scale</text><text x="500" y="85" text-anchor="middle" fill="#9a93b8" font-size="9">bottlenecks</text><text x="280" y="130" text-anchor="middle" fill="#fbbf24" font-size="9" font-weight="bold">Think aloud — interviewer evaluates your PROCESS</text><text x="280" y="155" text-anchor="middle" fill="#9a93b8" font-size="9">Start simple → identify bottlenecks → add caching/LB/DB</text><text x="280" y="180" text-anchor="middle" fill="#f06292" font-size="9">No perfect answer — just structured thinking</text></svg></div>
...
<div class="diagram"><svg viewBox="0 0 560 180" xmlns="http://www.w3.org/2000/svg"><text x="280" y="25" text-anchor="middle" fill="#fbbf24" font-size="11" font-weight="bold">Why Silence Kills Interviews</text><rect x="30" y="50" width="200" height="100" rx="8" fill="rgba(240,98,146,.06)" stroke="#f06292" stroke-width="2"/><text x="130" y="75" text-anchor="middle" fill="#f06292" font-size="10" font-weight="bold">10 min of silence</text><text x="130" y="100" text-anchor="middle" fill="#9a93b8" font-size="9">interviewer thinks:</text><text x="130" y="115" text-anchor="middle" fill="#9a93b8" font-size="9">"stuck? can't communicate?"</text><text x="130" y="135" text-anchor="middle" fill="#f06292" font-size="9">Red flag — even if code works</text><rect x="330" y="50" width="200" height="100" rx="8" fill="rgba(82,196,26,.06)" stroke="#52c41a" stroke-width="2"/><text x="430" y="75" text-anchor="middle" fill="#52c41a" font-size="10" font-weight="bold">10 min of narration</text><text x="430" y="100" text-anchor="middle" fill="#9a93b8" font-size="9">interviewer thinks:</text><text x="430" y="115" text-anchor="middle" fill="#9a93b8" font-size="9">"great problem-solver!"</text><text x="430" y="135" text-anchor="middle" fill="#52c41a" font-size="9">Green flag — even if stuck</text><text x="280" y="170" text-anchor="middle" fill="#fbbf24" font-size="9" font-weight="bold">Narrate: "I'm thinking X because Y... now I'll try Z"</text></svg></div>
...
<div class="diagram"><svg viewBox="0 0 560 200" xmlns="http://www.w3.org/2000/svg"><text x="280" y="25" text-anchor="middle" fill="#fbbf24" font-size="11" font-weight="bold">Salary Negotiation: The Anchor Effect</text><rect x="20" y="50" width="160" height="80" rx="8" fill="rgba(240,98,146,.06)" stroke="#f06292" stroke-width="2"/><text x="100" y="75" text-anchor="middle" fill="#f06292" font-size="10" font-weight="bold">You name first</text><text x="100" y="95" text-anchor="middle" fill="#9a93b8" font-size="9">"I expect $90K"</text><text x="100" y="115" text-anchor="middle" fill="#f06292" font-size="9">Anchor: $90K</text><rect x="200" y="50" width="160" height="80" rx="8" fill="rgba(251,191,36,.06)" stroke="#fbbf24" stroke-width="2"/><text x="280" y="75" text-anchor="middle" fill="#fbbf24" font-size="10" font-weight="bold">They negotiate</text><text x="280" y="95" text-anchor="middle" fill="#9a93b8" font-size="9">"We can do $85K"</text><text x="280" y="115" text-anchor="middle" fill="#fbbf24" font-size="9">Final: ~$85-88K</text><rect x="380" y="50" width="160" height="80" rx="8" fill="rgba(82,196,26,.06)" stroke="#52c41a" stroke-width="2"/><text x="460" y="75" text-anchor="middle" fill="#52c41a" font-size="10" font-weight="bold">If you waited</text><text x="460" y="95" text-anchor="middle" fill="#9a93b8" font-size="9">Their range: $80-100K</text><text x="460" y="115" text-anchor="middle" fill="#52c41a" font-size="9">You could get $95K+</text><text x="280" y="160" text-anchor="middle" fill="#fbbf24" font-size="9" font-weight="bold">Let them name the number first. Always.</text><text x="280" y="180" text-anchor="middle" fill="#9a93b8" font-size="9">Research: levels.fyi · Glassdoor · Blind</text></svg></div>
...
<div class="diagram"><svg viewBox="0 0 560 180" xmlns="http://www.w3.org/2000/svg"><text x="280" y="25" text-anchor="middle" fill="#fbbf24" font-size="11" font-weight="bold">Mock Interview Loop</text><rect x="20" y="50" width="120" height="60" rx="8" fill="rgba(45,212,191,.1)" stroke="#2dd4bf" stroke-width="2"/><text x="80" y="75" text-anchor="middle" fill="#2dd4bf" font-size="10" font-weight="bold">Practice</text><text x="80" y="95" text-anchor="middle" fill="#9a93b8" font-size="9">LeetCode + mock</text><defs><marker id="b" markerWidth="6" markerHeight="6" refX="4" refY="3" orient="auto"><path d="M0,0 L4,3 L0,6" fill="#34d399"/></marker></defs><line x1="140" y1="80" x2="180" y2="80" stroke="#34d399" stroke-width="2" marker-end="url(#b)"/><rect x="185" y="50" width="120" height="60" rx="8" fill="rgba(82,196,26,.1)" stroke="#52c41a" stroke-width="2"/><text x="245" y="75" text-anchor="middle" fill="#52c41a" font-size="10" font-weight="bold">Get Feedback</text><text x="245" y="95" text-anchor="middle" fill="#9a93b8" font-size="9">pramp.com</text><line x1="305" y1="80" x2="345" y2="80" stroke="#34d399" stroke-width="2" marker-end="url(#b)"/><rect x="350" y="50" width="120" height="60" rx="8" fill="rgba(251,191,36,.1)" stroke="#fbbf24" stroke-width="2"/><text x="410" y="75" text-anchor="middle" fill="#fbbf24" font-size="10" font-weight="bold">Fix Weakness</text><text x="410" y="95" text-anchor="middle" fill="#9a93b8" font-size="9">targeted drill</text><line x1="470" y1="80" x2="510" y2="80" stroke="#34d399" stroke-width="2" marker-end="url(#b)"/><rect x="475" y="50" width="70" height="60" rx="8" fill="rgba(167,139,250,.1)" stroke="#a78bfa" stroke-width="2"/><text x="510" y="75" text-anchor="middle" fill="#a78bfa" font-size="10" font-weight="bold">Repeat</text><text x="280" y="145" text-anchor="middle" fill="#fbbf24" font-size="9" font-weight="bold">3-5 mock interviews before every real one</text><text x="280" y="165" text-anchor="middle" fill="#9a93b8" font-size="9">Rejection = data. Each "no" teaches what to fix.</text></svg></div>
