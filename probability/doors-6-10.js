...
<svg viewBox="0 0 580 250" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto">
  ...
  <text x="30" y="55" text-anchor="end" fill="#64748b" font-size="10">6/36</text>
  <rect x="70" y="100" width="22" height="90" fill="#22c55e" stroke="#4ade80" stroke-width="1"/>
  <text x="81" y="95" text-anchor="middle" fill="#4ade80" font-size="10">2</text>
  <rect x="95" y="115" width="22" height="75" fill="#1e3a5f" stroke="#7dd3fc" stroke-width="1"/>
  <text x="106" y="110" text-anchor="middle" fill="#7dd3fc" font-size="10">3</text>
  <rect x="120" y="80" width="22" height="110" fill="#1e3a5f" stroke="#7dd3fc" stroke-width="1"/>
  <text x="131" y="75" text-anchor="middle" fill="#7dd3fc" font-size="10">4</text>
  <rect x="145" y="55" width="22" height="135" fill="#1e3a5f" stroke="#7dd3fc" stroke-width="1"/>
  <text x="156" y="50" text-anchor="middle" fill="#7dd3fc" font-size="10">5</text>
  ...
  <text x="206" y="50" text-anchor="middle" fill="#7dd3fc" font-size="10">8</text>
  <rect x="220" y="80" width="22" height="110" fill="#1e3a5f" stroke="#7dd3fc" stroke-width="1"/>
  <text x="231" y="75" text-anchor="middle" fill="#7dd3fc" font-size="10">9</text>
  <rect x="245" y="115" width="22" height="75" fill="#1e3a5f" stroke="#7dd3fc" stroke-width="1"/>
  <text x="256" y="110" text-anchor="middle" fill="#7dd3fc" font-size="10">10</text>
  <rect x="270" y="100" width="22" height="90" fill="#1e3a5f" stroke="#7dd3fc" stroke-width="1"/>
  <text x="281" y="95" text-anchor="middle" fill="#7dd3fc" font-size="10">11</text>
  <rect x="295" y="100" width="22" height="90" fill="#22c55e" stroke="#4ade80" stroke-width="1"/>
  <text x="306" y="95" text-anchor="middle" fill="#4ade80" font-size="10">12</text>
  ...
  <text x="395" y="78" fill="#e2e8f0" font-size="10">P(E) = favorable / total</text>
  <text x="395" y="93" fill="#4ade80" font-size="10">P(A∪B)=P(A)+P(B)−P(A∩B)</text>
  <text x="395" y="108" fill="#7dd3fc" font-size="10">P(A|B) = P(A∩B)/P(B)</text>
  ...
  <text x="475" y="188" text-anchor="middle" fill="#cbd5e1" font-size="10">থাকলে 1/3 জয়</text>
  <text x="475" y="202" text-anchor="middle" fill="#fcd34d" font-size="10">গোনা প্রমাণ করে!</text>
</svg>
</div>
...
<svg viewBox="0 0 580 250" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto">
  ...
  <text x="45" y="60" text-anchor="end" fill="#64748b" font-size="10">0.22</text>
  <text x="45" y="125" text-anchor="end" fill="#64748b" font-size="10">0.10</text>
  <rect x="65" y="115" width="30" height="80" fill="#1e3a5f" stroke="#7dd3fc" stroke-width="1"/>
  <text x="80" y="208" text-anchor="middle" fill="#7dd3fc" font-size="10">0</text>
  <text x="80" y="110" text-anchor="middle" fill="#7dd3fc" font-size="10">0.05</text>
  <rect x="100" y="60" width="30" height="135" fill="#fbbf24" stroke="#fcd34d" stroke-width="1.5"/>
  <text x="115" y="208" text-anchor="middle" fill="#fcd34d" font-size="10">1</text>
  <text x="115" y="55" text-anchor="middle" fill="#fcd34d" font-size="10">0.15</text>
  <rect x="135" y="50" width="30" height="145" fill="#22c55e" stroke="#4ade80" stroke-width="1.5"/>
  <text x="150" y="208" text-anchor="middle" fill="#4ade80" font-size="10">2</text>
  <text x="150" y="45" text-anchor="middle" fill="#4ade80" font-size="10">0.22</text>
  <rect x="170" y="55" width="30" height="140" fill="#fbbf24" stroke="#fcd34d" stroke-width="1.5"/>
  <text x="185" y="208" text-anchor="middle" fill="#fcd34d" font-size="10">3</text>
  <text x="185" y="50" text-anchor="middle" fill="#fcd34d" font-size="10">0.20</text>
  <rect x="205" y="80" width="30" height="115" fill="#22d3ee" fill-opacity="0.7" stroke="#7dd3fc" stroke-width="1"/>
  <text x="220" y="208" text-anchor="middle" fill="#7dd3fc" font-size="10">4</text>
  <rect x="240" y="110" width="30" height="85" fill="#8b5cf6" fill-opacity="0.7" stroke="#a78bfa" stroke-width="1"/>
  <text x="255" y="208" text-anchor="middle" fill="#a78bfa" font-size="10">5</text>
  <rect x="275" y="140" width="30" height="55" fill="#8b5cf6" fill-opacity="0.5" stroke="#a78bfa" stroke-width="1"/>
  <text x="290" y="208" text-anchor="middle" fill="#a78bfa" font-size="10">6</text>
  ...
  <text x="365" y="158" fill="#cbd5e1" font-size="10">• কল সেন্টার: ৩ কল/মিনিট</text>
  <text x="365" y="172" fill="#cbd5e1" font-size="10">• ওয়েবসাইট: ১০ ভিজিটর/সেকেন্ড</text>
  <text x="365" y="186" fill="#cbd5e1" font-size="10">• মিউটেশন: ০.১/জিন</text>
  <text x="365" y="200" fill="#cbd5e1" font-size="10">• দুর্ঘটনা: ২/দিন</text>
  <text x="365" y="215" fill="#4ade80" font-size="10">→ বিরল কিন্তু নিয়মিত!</text>
</svg>
</div>
...
<svg viewBox="0 0 580 250" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto">
  ...
  <text x="150" y="112" text-anchor="middle" fill="#fcd34d" font-size="10">0.67 (stationary)</text>
  ...
  <text x="400" y="112" text-anchor="middle" fill="#7dd3fc" font-size="10">0.33 (stationary)</text>
  ...
  <text x="150" y="50" text-anchor="middle" fill="#fcd34d" font-size="10">0.8</text>
  <path d="M 375,75 A 30,30 0 0,1 425,75" fill="none" stroke="#7dd3fc" stroke-width="2" marker-end="url(#arrPB8b)"/>
  <text x="400" y="50" text-anchor="middle" fill="#7dd3fc" font-size="10">0.6</text>
  ...
  <text x="427" y="218" text-anchor="middle" fill="#cbd5e1" font-size="10">অতীত নয়! PageRank = Markov chain</text>
</svg>
</div>
...
<svg viewBox="0 0 580 250" xmlns="http://www.w3.org/2000/svg" style="width:100%;height:auto">
  ...
  <text x="200" y="45" text-anchor="middle" fill="#7dd3fc" font-size="10">Square: 2x2</text>
  <circle cx="200" cy="150" r="100" fill="none" stroke="#22c55e" stroke-width="2"/>
  <text x="200" y="260" text-anchor="middle" fill="#4ade80" font-size="10">Circle: r=1</text>
  ...
  <text x="400" y="105" fill="#94a3b8" font-size="10">N = 10,000 samples</text>
  <text x="400" y="120" fill="#4ade80" font-size="10">Inside: 7,854</text>
  <text x="400" y="135" fill="#fca5a5" font-size="10">Outside: 2,146</text>
  <text x="400" y="160" fill="#fcd34d" font-size="8">pi ~= 4 * 7854/10000</text>
  <text x="400" y="175" fill="#fcd34d" font-size="8">   = 3.1416</text>
  <text x="400" y="200" fill="#c084fc" font-size="10">MCMC: Metropolis-Hastings</text>
  <text x="400" y="212" fill="#c084fc" font-size="10">Gibbs sampling</text>
</svg>
</div>
