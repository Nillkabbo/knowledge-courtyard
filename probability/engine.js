// ══════════════════════════════════════
// Book 49 · Probability & Stochastic Processes — Engine
// ══════════════════════════════════════
let state = { xp:0, currentDoor:null, completedDoors:[], prologueSeen:false };
const XP_PER_DOOR = 100;
const SAVE_KEY = 'prob_v1';
const MAX_XP = 1000;
const RANKS = [
  {min:0,   name:'সন্ধানী',          icon:'🔍'},
  {min:100, name:'কন্টেইনার কারিগর',  icon:'📦'},
  {min:200, name:'ক্লাস্টার যোদ্ধা',   icon:'☸️'},
  {min:300, name:'পাইপলাইন প্রহরী',   icon:'🔄'},
  {min:400, name:'নির্ভরযোগ্যতা পাহারদার',icon:'📊'},
  {min:500, name:'অবজারভার ঋষি',      icon:'👁️'},
  {min:600, name:'ক্লাউড স্থপতি',     icon:'☁️'},
  {min:700, name:'আকাশ দুর্গের গুরু',  icon:'🏰'}
];
