...
<div class="dialogue">তুমি ২৭টা বই পড়েছ। ২৭টা বাড়ি। কিন্তু কোনো রাস্তা নেই। RAG শিখেছ (Book ১০), কিন্তু human psychology-এর (Book ২৪) সাথে সংযুক্ত করোনি। Prompt engineering (Book ৭) শিখেছ, কিন্তু research paper reading-এর (Book ২৭) সাথে যুক্ত করোনি। System design (Book ৪) জানো, কিন্তু fine-tuning-এর (Book ১১) সাথে সংযুক্ত করোনি। প্রতিটা বই একটা দ্বীপ। সম্পদ আছে — কিন্তু সেতু নেই।</div></div>
<div class="dialogue en">"You've read 27 books. 27 houses. But no roads. You learned RAG (Book 10), but didn't connect it to human psychology (Book 24). You learned prompt engineering (Book 7), but didn't link it to research paper reading (Book 27). You know system design (Book 4), but haven't connected it to fine-tuning (Book 11). Each book is an island. Resources exist — but no bridges."</div></div>

<div class="callout warn"><span class="co-icon">🧩</span><div><strong>Silo সমস্যা:</strong> বিচ্ছিন্ন জ্ঞান = আলাদা বিন্দু, মাঝে কোনো রেখা নেই। যখন সমস্যায় RAG + Psychology একসাথে লাগে, silo-মন শুধু বিন্দু দেখে, পথ দেখে না। সংযুক্ত জ্ঞানে বিন্দুর মাঝে রেখা = <em>understanding</em>; যত বেশি রেখা, তত গভীর বোঝা।</div></div></div>
<div class="callout info"><span class="co-icon">🔨</span><div><strong>Munger-এর "man with a hammer":</strong> "যার কাছে শুধু হাতুড়ি, তার কাছে সব সমস্যা পেরেক।" শুধু deep learning জানলে সব সমস্যা = neural net; শুধু system design জানলে সব = architecture। সমাধান — বহু ক্ষেত্রের মডেল নিয়ে <strong>latticework</strong> (দ্বার ৩)।</div></div></div>
<div class="callout tip"><span class="co-icon">🕸️</span><div><strong>তোমার ২৭টা বই এখনো যথেষ্ট নয় (yet):</strong> বিচ্ছিন্ন থাকলে সেগুলো শুধু <em>information</em> দিয়েছে, understanding বা সৃষ্টির ক্ষমতা নয়। সংযুক্ত করলে একই ২৭টা বই হয়ে ওঠে <strong>knowledge web</strong> — যেকোনো ডোমেইন combine করে নতুন সমাধান তৈরি করা যায়। (Hawkins 2004: বুদ্ধিমত্তা = সংযোগের ঘনত্ব; Doidge 2007: প্রতিটা নতুন neuron-সংযোগই শেখা।)</div></div></div>
...
<div class="dialogue">আয়ত — sign, symbol, evidence। কুরআনে আল্লাহ বলেন — "আমি প্রতিটি জিনিসে নিদর্শন রেখেছি যারা চিন্তা করে।" নিদর্শন আলাদা নয় — সংযুক্ত। একটা পাতা একটা নিদর্শন। কিন্তু পাতা + ফুল + ফল + শিকড় = একটা গাছ। গাছ + মাটি + পানি + সূর্য = একটা বাস্তুতন্ত্র। প্রতিটা স্তর আগের স্তরের সাথে সংযুক্ত। আলাদা নিদর্শন দেখা = সংযোগ না দেখা। সংযুক্ত নিদর্শন দেখা = আয়ত বোঝা। এটাই জ্ঞানের জাল।</div></div>
...
</svg></div><div class="svg-caption">ধারণার জাল — বিচ্ছিন্ন বিন্দু থেকে সংযুক্ত নেটওয়ার্ক</div></div>
...
<div class="dialogue en">"Silos said — isolated knowledge is fragile. But I say — the first tool of connection is analogy. You map the new to the known. Gentner (1983) calls it structure-mapping theory. The brain says — 'this is like that.' But a good analogy doesn't just show similarity — it shows where the similarity ENDS. Zettelkasten and neural networks are alike — but Zettelkasten has no backpropagation. That's where they differ."</div></div>

<div class="callout info"><span class="co-icon">🌉</span><div><strong>Gentner-এর structure-mapping (1983):</strong> মানুষ নতুন ধারণা বোঝে পরিচিত ডোমেইন (source) থেকে গঠন (target)-এ ম্যাপ করে। "পরমাণু সৌরজগতের মতো" — sun↔nucleus, planet↔electron; চেহারা নয়, <em>সম্পর্ক</em> ম্যাপ হয়।</div></div></div>
...
<div class="callout tip"><span class="co-icon">🔁</span><div><strong>দৈনিক analogy exercise:</strong> নতুন কিছু শিখলে — ① "এটা কীসের মতো?" ② কী ম্যাপ হয় (গঠন)? ③ কী ম্যাপ হয় না (সীমা)? ④ analogy থেকে আর কী সত্য হতে পারে? ⑤ test করো। (Einstein: "আলো train-এর মতো হলে? gravity trampoline-এর মতো হলে?" Polya 1945: "এই সমস্যা কি sorting/search/graph-এর মতো?")</div></div></div>
...
</svg></div><div class="svg-caption">উপমা — Gentner-এর structure-mapping: জানা → নতুন</div></div>
...
<div class="callout info"><span class="co-icon">🧪</span><div><strong>Gap খোঁজার টেস্ট:</strong> <strong>Feynman gap</strong> — সহজ করে ব্যাখ্যা করো, যেখানে আটকাও সেই gap। <strong>Connection gap</strong> — প্রতি বই-জোড়ায় "X কীভাবে Y-এর সাথে যুক্ত?"; না পারলে gap। <strong>Application gap</strong> — বইয়ের জ্ঞান বাস্তব সমস্যায় প্রয়োগ করো, যেখানে ভাঙে সেই assumption/gap ("আমি একটা system হিসেবে — আমার bottleneck কী?")।</div></div></div>
...
<div class="dialogue">gap finder বলেছিলেন — ফাঁক খোঁজো। কিন্তু আমি বলি — ফাঁক পূরণের সবচেয়ে শক্তিশালী উপায় insight। তুমি চেতনভাবে সংযুক্ত করতে পারো না — কিন্তু তোমার মস্তিষ্ক পারে। ঘুমানো, হাঁটা, গোসল — এই সময়ে মস্তিষ্ক সংযুক্ত করে। Kounios ও Beeman দেখালেন — insight এলোমেলো নয়। এটা মস্তিষ্কের একটা নির্দিষ্ট প্রক্রিয়া। default mode network। gamma waves। ইলহাম — হঠাৎ জ্ঞান।</div></div>
<div class="dialogue en">"The gap finder said — find the gaps. But I say — the most powerful way to fill gaps is insight. You can't consciously connect — but your brain can. Sleeping, walking, showering — during these times the brain connects. Kounios & Beeman showed — insight isn't random. It's a specific brain process. Default mode network. Gamma waves. Ilham — sudden knowledge."</div></div>

<div class="callout info"><span class="co-icon">💡</span><div><strong>Kounios & Beeman (2009):</strong> EEG+fMRI-তে দেখা গেল "aha!" মস্তিষ্কের সত্যিকারের ঘটনা — right anterior superior temporal gyrus-এ ~৪০Hz gamma-wave burst (~৩০০ ms), তার আগে একটা "brain blink" (মস্তিষ্ক ক্ষণিকের জন্য ভেতরে ফেরে)। এটা ঘটে যখন দুটো দূরবর্তী ধারণা জোড়া লাগে।</div></div></div>
...
</svg></div><div class="svg-caption">অন্তর্দৃষ্টির কারখানা — দূরবর্তী ধারণার হঠাৎ সংযোগ, aha! মুহূর্ত</div></div>

<div class="dialogue">ইলহাম — divine inspiration, sudden knowledge। ইসলামী ঐতিহ্যে ইলহাম হলো এমন জ্ঞান যা হঠাৎ আসে — চেষ্টা ছাড়া। নবীগণ ইলহাম পেতেন। কিন্তু সাধারণ মানুষও insight পায় — যখন তারা গভীরভাবে চিন্তা করে, তারপর ছেড়ে দেয়। মস্তিষ্ক বিশ্রামে সংযুক্ত করে। ইলহাম। Kounios ও Beeman দেখালেন — এটা মস্তিষ্কের প্রক্রিয়া। default mode network। gamma waves। ইলহাম এলোমেলো নয় — এটা প্রস্তুতির ফল। যে গভীরভাবে চিন্তা করে, তারপর ছাড়ে — তার মস্তিষ্ক সংযুক্ত করে। ইলহাম।</div></div>
