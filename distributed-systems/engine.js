...
const SAVE_KEY = 'distributedSystems_v1';
const MAX_XP = 1000;
const RANKS = [
  {min:0,   name:'একক স্থপতি',     icon:'🖥️'},
  {min:100, name:'নোড সংযোগকারী',   icon:'🔗'},
  {min:200, name:'ক্লাস্টার প্রভাবী',     icon:'🌐'},
  {min:300, name:'আর্কিটেক্ট',     icon:'🏛️'},
  {min:400, name:'কনসেনসাস কারিগর',           icon:'⚖️'},
  {min:500, name:'স্কেল গুরু',     icon:'📈'},
  {min:600, name:'ফল্ট-টলারেন্ট প্রভু',    icon:'🛡️'},
  {min:700, name:'বিতরণ মাস্টার',    icon:'👑'}
];
