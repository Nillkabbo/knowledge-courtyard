...
const SAVE_KEY='optimizationBook_v1';
const MAX_XP = 1000;
const RANKS = [
  {min:0,   name:'সন্ধানী পথিক',    icon:'🧭'},
  {min:100, name:'ঢালু পথিক',      icon:'📉'},
  {min:200, name:'উতলা অঞ্চল',     icon:'📐'},
  {min:300, name:'সীমাবদ্ধ যোদ্ধা', icon:'⚖️'},
  {min:400, name:'স্টোকাস্টিক পথিক',icon:'🎲'},
  {min:500, name:'বেগবান কারিগর',  icon:'⚡'},
  {min:600, name:'অ-উতল অভিযাত্রী',icon:'🏔️'},
  {min:700, name:'বিচ্ছিন্ন স্থপতি',icon:'🎯'},
  {min:800, name:'সমন্বয় গুরু',   icon:'🌐'},
  {min:900, name:'পথের সুলতান',    icon:'👑'}
];
