// ════════════════════════════════════════
// Book 59 · The Terminal Craftsman — Claude Code Mastery Engine
// ════════════════════════════════════════
let state = { xp:0, currentDoor:null, completedDoors:[], prologueSeen:false };
const XP_PER_DOOR = 100;
const SAVE_KEY = 'claudeCodeMastery_v9';
const MAX_XP = 6000;
const RANKS = [
  ...
  {min:2600, name:'নিজ-রাজ্যের কারিগর', icon:'🛠️'},
  {min:2800, name:'রীতি-স্রষ্টা', icon:'📜'},
  {min:3100, name:'নিজ-রাজ্যের স্থপতি', icon:'🏛️'},
  {min:3300, name:'রীতি-স্রষ্টা-উস্তাদ', icon:'🥇'},
  ...
  {min:5600, name:'ল্যাব-কারিগর', icon:'🧪'},
  {min:6000, name:'নিজের কারখানার উদ্বোধক', icon:'🎉'}
];
