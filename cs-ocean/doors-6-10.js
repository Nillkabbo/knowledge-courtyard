...
// The Ocean of Computer Science: SE → Synthesis
// ════════════════════════════════════════

// ══ DOOR 6: SOFTWARE ENGINEERING & PROGRAMMING LANGUAGES ══
doors.push({
  num:6, icon:"⚙️", color:"#64748b", name:"কোডের কারখানা",
  subtitle:"The Code Factory", tech:"Software Engineering & Programming Languages",
  spirit:"ইহসান — সুন্দরভাবে কাজ করা, যেন আল্লাহ দেখছেন",
  secret:"SE/PL গবেষণা হলো — কীভাবে ভালো কোড লেখা যায়, কীভাবে ভাষা ডিজাইন করা যায়। Niche ডোমেইন, কম প্রতিযোগিতা, স্থিতিশীল ক্যারিয়ার। প্রতিটা ডেভেলপার SE ব্যবহার করে — git, testing, CI/CD। কিন্তু কেউ ভাবে না সেটা কেন কাজ করে। গবেষক সেটা ভাবে।",
  recall:{
    q:"রবার্ট কেন বললেন কারখানা বন্ধ হলে কাজ চলে, কিন্তু খারাপ কোড চলে?",
    qen:"Why did Robert say a factory can stop, but bad code keeps running?",
    a:"কারণ একটা কারখানা বন্ধ হলে শুধু সেই কারখানা থামে। কিন্তু খারাপ কোড একবার deploy হলে — লাখ লাখ মানুষের সিস্টেমে চলে, বাগ ছড়ায়, security hole তৈরি করে। SE গবেষণা হলো — কোডের মান বাড়ানো, যাতে কোড নিরাপদ, নির্ভরযোগ্য, maintainable হয়। ইহসান = সুন্দর কোড।",
    aen:"Because a factory stopping affects only that factory. But bad code once deployed — runs on millions of systems, spreads bugs, creates security holes. SE research is — improving code quality, so code is safe, reliable, maintainable. Ihsan = beautiful code."
  },
  story:`
<p class="scene-setting">ষষ্ঠ দরজা। একটা বিশাল কারখানা — কনভেয়র বেল্টে কোডের ব্লক চলছে। কিছু ব্লক পরিষ্কার, কিছু জট পাকানো। দেয়ালে টানানো — টেস্ট কভারেজ গ্রাফ, বাগ রিপোর্ট, কোড মেট্রিক্স। মাঝখানে দাঁড়িয়ে আছেন রবার্ট — সাদা কোট, হাতে একটা ম্যাগনিফাইং গ্লাস, চোখে নিপুণতা। মেশিনের গর্জন, ধাতব ক্লিক, তেলের গন্ধ।</p>
<p class="scene-setting en">The sixth door. A vast factory — code blocks moving on conveyor belts. Some blocks clean, some tangled. On walls: test coverage graphs, bug reports, code metrics. In the center stands Robert — white coat, magnifying glass in hand, precision in his eyes. Machine roar, metallic clicks, smell of oil.</p>
...
<div class="secret-box">⚙️ SE/PL: কীভাবে ভালো কোড লেখা যায়। মাঝারি প্রতিযোগিতা (৬-১০%), stable ক্যারিয়ার। AI4SE (LLM দিয়ে কোড) = হট area। তোমার প্রতিদিনের কাজ — git, testing, CI/CD — এখানে কাজে দেবে।</div>`
});

// ══ DOOR 7: THEORY & ALGORITHMS ══
doors.push({
  num:7, icon:"📐", color:"#fbbf24", name:"তত্ত্বের চূড়া",
  subtitle:"The Peak of Theory", tech:"Theoretical Computer Science & Algorithms",
  spirit:"বুরহান — দলিল, প্রমাণ, নিশ্চিত জ্ঞান",
  secret:"Theory হলো CS-এর সবচেয়ে কঠিন ডোমেইন — কিন্তু সবচেয়ে গভীর। গণিত, প্রমাণ, লজিক। P vs NP, complexity, cryptography-র ভিত্তি। কম ছাত্র, কম প্রতিযোগিতা — কিন্তু যারা যায়, তারা সবচেয়ে সম্মানিত। তুমি যদি গণিত ভালোবাসো — এটা তোমার ডোমেইন।",
  recall:{
    q:"ডেভিড কেন বললেন চূড়ায় পৌঁছাতে হলে এক পা এক পা করে উঠতে হয়?",
    qen:"Why did David say reaching the peak requires stepping up one step at a time?",
    a:"কারণ তত্ত্ব হলো এক পা এক পা করে উঠা — প্রতিটা ধাপ একটা উপপাদ্য। কোনো shortcut নেই। প্রতিটা প্রমাণ শক্ত হতে হয়। দুর্বল প্রমাণ = দুর্বল সিঁড়ি = পড়ে যাওয়া। গণিতের পথ ধীর, কিন্তু একবার চূড়ায় পৌঁছালে তুমি সবকিছু দেখো — সম্পূর্ণ দৃশ্যমান।",
    aen:"Because theory is climbing step by step — each step is a theorem. No shortcuts. Each proof must be solid. Weak proof = weak stairs = falling. The mathematical path is slow, but once you reach the peak, you see everything — the complete picture."
  },
  story:`
<p class="scene-setting">সপ্তম দরজা। একটা বিশাল পাথরের সিঁড়ি — উপরে উঠে গেছে মেঘের ভেতরে। প্রতিটা ধাপে খোদাই করা সংখ্যা আর প্রতীক। সিঁড়ির কিনারায় দাঁড়িয়ে আছেন ডেভিড — লম্বা, রোগা, চশমা নাকে, হাতে একটা খাতা ভর্তি সমীকরণ। তাঁর চোখে গভীরতা, মুখে শান্ত গর্ব। উঁচু থেকে আসা ঠান্ডা বাতাস, পাথরের কঠিন স্পর্শ, দূরে বাজপাখির ডাক।</p>
<p class="scene-setting en">The seventh door. A vast stone staircase — climbing into clouds. Each step carved with numbers and symbols. At the staircase's edge stands David — tall, thin, glasses on nose, a notebook full of equations in hand. Depth in his eyes, quiet pride on his face. Cold wind from above, hard touch of stone, distant eagle cry.</p>
...
<div class="dialogue">বুরহান — দলিল, প্রমাণ। কুরআনে আল্লাহ বলেন: আমি প্রতিটা জিনিসের দলিল দিয়েছি। তত্ত্ব হলো বুরহান — নিশ্চিত প্রমাণ। অন্যান্য ডোমেইনে তুমি experiment দিয়ে প্রমাণ করো — কিন্তু experiment ভুল হতে পারে। Theory-তে তুমি proof দিয়ে প্রমাণ করো — proof চিরন্তন। একবার প্রমাণিত theorem কখনো বদলায় না। Euclid-এর theorem আজও সত্য, হাজার বছর পরেও সত্য। এটা বুরহান — নিশ্চিত জ্ঞান।</div>
<div class="dialogue en">Burhan — proof, evidence. Allah says: We have given proof for everything. Theory is burhan — certain proof. In other domains, you prove by experiment — but experiments can be wrong. In theory, you prove with proof — proof is eternal. A proven theorem never changes. Euclid's theorem is true today, true in a thousand years. This is burhan — certain knowledge.</div>

<div class="secret-box">📐 Theory: CS-এর সবচেয়ে গভীর ডোমেইন। কঠিন, কিন্তু সবচেয়ে সম্মানিত। গণিত, প্রমাণ, লজিক। কম ছাত্র (৬-১০%), কিন্তু যারা যায় — academic জগতে শ্রদ্ধেয়। গণিত ভালোবাসলে যাও।</div>`
});

// ══ DOOR 8: QUANTUM COMPUTING ══
doors.push({
  num:8, icon:"⚛️", color:"#818cf8", name:"কোয়ান্টামের কণা",
  subtitle:"The Quantum Particle", tech:"Quantum Computing & Quantum Information",
  spirit:"লাতাইফ — সূক্ষ্ম, অদৃশ্য কিন্তু সত্য",
  secret:"Quantum computing হলো ভবিষ্যতের ডোমেইন — এখনও শুরু। কম ছাত্র, কম প্রতিযোগিতা, কিন্তু প্রতিটা বিশ্ববিদ্যালয় quantum lab খুলছে। পদার্থবিজ্ঞান + CS + গণিত — তিনযুক্ত। যদি তুমি ভবিষ্যতের অগ্রিকেতে থাকতে চাও — এটা তোমার ডোমেইন। কিন্তু পদার্থবিজ্ঞান শক্তিশালী হতে হবে।",
  recall:{
    q:"সারা কেন বললেন একটা কণা একই সাথে দুই জায়গায় থাকতে পারে?",
    qen:"Why did Sara say a particle can be in two places at once?",
    a:"কারণ কোয়ান্টাম পদার্থবিজ্ঞানে এটাই সত্য — superposition। একটা qubit একই সাথে 0 আর 1 হতে পারে। এটা সাধারণ মস্তিষ্কে বোঝা কঠিন — কিন্তু এটাই কোয়ান্টামের শক্তি। কোয়ান্টাম কম্পিউটার একই সাথে লাখোপ্রকার হিসাব করতে পারে — কারণ প্রতিটা qubit একাধিক অবস্থায় থাকে। সূক্ষ্ম, কিন্তু শক্তিশালী।",
    aen:"Because in quantum physics this is true — superposition. A qubit can be 0 and 1 simultaneously. Hard for ordinary minds to grasp — but this is quantum's power. A quantum computer can compute millions of possibilities simultaneously — because each qubit exists in multiple states. Subtle, but powerful."
  },
  story:`
<p class="scene-setting">অষ্টম দরজা। একটা ঘর — কিন্তু সবকিছু একটু অস্পষ্ট, যেন স্বপ্ন। দেয়ালে ভাসমান সমীকরণ, ঘরের মাঝখানে একটা জ্বলজ্বলে ব্ল্যাক-বক্স — ভেতরে একটা কোয়ান্টাম প্রসেসর। বক্সের পাশে দাঁড়িয়ে আছেন সারা — কার্লি চুল, গাঢ় নীল চোখ, হাতে একটা লেজার পয়েন্টার। তাঁর মুখে বিস্ময়, চোখে ভবিষ্যতের দৃষ্টি। স্নায়বিক শীতল বাতাস, হালকা বাজ শব্দ, ধাতব ঠান্ডা স্পর্শ।</p>
<p class="scene-setting en">The eighth door. A room — but everything slightly blurry, dreamlike. Floating equations on walls, a glowing black-box in the center — inside, a quantum processor. Beside the box stands Sara — curly hair, deep blue eyes, a laser pointer in hand. Wonder on her face, future-vision in her eyes. Nerve-cooling air, faint hum, metallic cold touch.</p>
...
<div class="dialogue">লাতাইফ — সূক্ষ্ম, অদৃশ্য কিন্তু সত্য। কুরআনে আল্লাহ বলেন: আমি মানুষকে শপথ করাচ্ছি নফস ও তার সুস্থিতির — যিনি মানুষকে সুস্থ করেছেন, তিনি তাকে পথ দেখাবেন। লাতাইফ মানে — সেই সত্য যা চোখে দেখা যায় না কিন্তু আছে। কোয়ান্টাম হলো লাতাইফ — সূক্ষ্ম, অদৃশ্য, কিন্তু পরিমাপযোগ্য। একটা electron কোথায় আছে — দেখা যায় না। কিন্তু wave function বলে সম্ভাবনা। এটাই কোয়ান্টাম — অদৃশ্য কিন্তু সত্য। যে এই সূক্ষ্ম সত্য খোঁজে, সে প্রকৃতির গভীরতম নিয়ম খুঁজে পায়।</div>
<div class="dialogue en">Lataif — subtle, invisible but true. Allah says: By the soul and He who proportioned it. Lataif means — truth that can't be seen but exists. Quantum is lataif — subtle, invisible, but measurable. Where is an electron? Can't be seen. But wave function tells probability. This is quantum — invisible but true. One who seeks this subtle truth, discovers nature's deepest laws.</div>

<div class="secret-box">⚛️ Quantum: ভবিষ্যতের ডোমেইন। এখন শুরু — ১৯৬০-এর classical-এর মতো। পদার্থবিজ্ঞান + CS + গণিত দরকার। কম প্রতিযোগিতা (৫-৮%), দ্রুত বর্ধনশীল ফান্ডিং ($১.২B)। অগ্রিকে হতে চাইলে এখনই শুরু।</div>`
});

// ══ DOOR 9: ROBOTICS & AUTONOMOUS SYSTEMS ══
doors.push({
  num:9, icon:"🤖", color:"#f97316", name:"যন্ত্রের প্রাণ",
  subtitle:"The Soul of Machines", tech:"Robotics & Autonomous Systems",
  spirit:"আমানত — আস্থা, দায়িত্ব পালন",
  secret:"Robotics হলো যেখানে CS পরিচয় পায় — কোড বাস্তব জগতে চলে। কম প্রতিযোগিতা, ভালো ফান্ডিং (DARPA, defense)। শারীরিক জগতের সাথে কাজ — perception, planning, control। Autonomous vehicles, drones, surgical robots, space robots। এটা CS + ME + EE — interdisciplinary।",
  recall:{
    q:"কেভিন কেন বললেন রোবট একটা আমানত, শুধু মেশিন নয়?",
    qen:"Why did Kevin say a robot is a trust, not just a machine?",
    a:"কারণ রোবট যখন বাস্তব জগতে চলে, তখন তার আমানত থাকে — মানুষের নিরাপত্তা। একটা self-driving গাড়ি ভুল করলে মানুষ মারা যায়। একটা surgical robot ভুল করলে রোগীর ক্ষতি। রোবট গবেষণা শুধু কোড নয় — দায়িত্ব। যে রোবট বানায়, সে আমানত বহন করে — মানুষের জীবনের আমানত।",
    aen:"Because when a robot moves in the real world, it carries a trust — people's safety. A self-driving car makes a mistake, people die. A surgical robot fails, patient harmed. Robot research isn't just code — it's responsibility. One who builds robots, carries a trust — the trust of human life."
  },
  story:`
<p class="scene-setting">নবম দরজা। একটা বিশাল কর্মশালা — সবুজ মেঝে, উপরে ঝুলছে রোবট হাত, মাঝে দাঁড়িয়ে একটা humanoid robot — অর্ধেক সম্পূর্ণ, ভেতরের তার দেখা যাচ্ছে। রোবটের পাশে দাঁড়িয়ে আছেন কেভিন — নীল কোট, হাতে একটা soldering iron, মুখে ঘন গোঁফ। তাঁর চোখে নিবিড়তা, হাত স্থির। মেশিনের হুম শব্দ, সার্ভো মোটরের ঝিঁঝিঁ, তারের পোড়া গন্ধ।</p>
<p class="scene-setting en">The ninth door. A vast workshop — green floor, robotic arms hanging above, in the center a humanoid robot — half-finished, inner wires visible. Beside the robot stands Kevin — blue coat, soldering iron in hand, thick mustache. Intensity in his eyes, steady hands. Machine hum, servo whine, smell of burnt wire.</p>
...
<div class="secret-box">🤖 Robotics: CS যেখানে শরীর পায়। ভালো ফান্ডিং (DARPA $১B+), মাঝারি প্রতিযোগিতা (৫-৮%)। Autonomous vehicles, surgical robots, space robots। CS + ME + EE interdisciplinary। বাস্তব জগতে সরাসরি impact।</div>`
});

// ══ DOOR 10: INTERDISCIPLINARY & EMERGING — THE NAVIGATOR'S CHOICE ══
doors.push({
  num:10, icon:"🧭", color:"#38bdf8", name:"নেভিগেটরের পছন্দ",
  subtitle:"The Navigator's Choice", tech:"Emerging Domains + PhD Selection Framework",
  spirit:"তাওফিক — সঠিক পথে চলা, আল্লাহর সাহায্য",
  secret:"দশটা ডোমেইন দেখলে। এখন সিদ্ধান্ত: কোনটা তোমার? এই দরজায় তুমি পাবে — emerging domains (Bio-CS, Edge AI, AI Ethics) এবং একটা decision framework। তিনটা প্রশ্নের উত্তর দাও — interest, strength, market — তোমার ডোমেইন পেয়ে যাবে। এটাই তোমার সবচেয়ে গুরুত্বপূর্ণ সিদ্ধান্ত।",
  recall:{
    ...
    a:"কারণ কম্পাস শুধু দিক দেখায় — সিদ্ধান্ত তোমার। কোন ডোমেইন সেরা — সেটা কম্পাস বলবে না। কম্পাস বলবে কোনটায় কী আছে। কিন্তু তুমি কোনটা বেছে নেবে — সেটা তোমার আগ্রহ, তোমার শক্তি, তোমার লক্ষ্যের উপর নির্ভর করে। কম্পাস তোমাকে দিক দেখাবে — হাঁটতে হবে তোমাকে।",
    aen:"Because the compass only shows direction — the decision is yours. Which domain is best — the compass won't say. The compass tells what's in each. But which you choose — depends on your interest, your strength, your goal. The compass shows direction — you must walk."
  },
  story:`
<p class="scene-setting">দশম দরজা। তুমি একটা বিশাল মানচিত্রের টেবিলের সামনে — সব ডোমেইনের মানচিত্র ছড়ানো। আগের নয়জন শিক্ষক পেছনে দাঁড়িয়ে — প্রত্যেকে তাঁদের ডোমেইনের দিকে তাকিয়ে। মানচিত্রের পাশে দাঁড়িয়ে আছেন নাভিদ — নেভিগেটরের পোশাক, হাতে একটা পিতলের কম্পাস, মুখে স্নিগ্ধ হাসি। তাঁর চোখে অভিজ্ঞতা, মুখে সান্ত্বনা। সমুদ্রের লবণাক্ত বাতাস, কাগজের শুকনো শব্দ, দূরে গালের শব্দ।</p>
<p class="scene-setting en">The tenth door. You stand before a vast map table — maps of all domains spread out. The previous nine teachers stand behind — each looking toward their domain. Beside the map stands Navid — navigator's garb, a brass compass in hand, gentle smile on face. Experience in his eyes, comfort on his face. Salty sea air, dry paper sound, distant gull cry.</p>
...
<div class="dialogue">তাওফিক — সঠিক পথে চলা, আল্লাহর সাহায্য। কুরআনে আল্লাহ বলেন: যারা সৎপথে চলে, তিনি তাদের আরও সৎপথ দেন। তোমার ডোমেইন নির্বাচন করার পর — তাওফিক চাও। ইস্তিখারা করো। আল্লাহর কাছে সাহায্য চাও। কারণ তুমি যেটা ভালো মনে করো, সেটা হয়তো ভালো নয়। আল্লাহ যেটা ভালো জানেন, সেটা হয়তো তোমার কাছে অজানা। তাওফিক চাও — আল্লাহ তোমাকে সেই ডোমেইনে নিয়ে যাবেন যেখানে তোমার জ্ঞান সবচেয়ে বেশি কল্যাণ করবে। এটাই গবেষকের সর্বোচ্চ লক্ষ্য — জ্ঞান দিয়ে কল্যাণ।</div>
<div class="dialogue en">Tawfiq — walking the right path, Allah's help. Allah says: those who walk the right path, He increases their guidance. After choosing your domain — seek tawfiq. Do istikhara. Ask Allah for help. Because what you think is good may not be. What Allah knows is good may be unknown to you. Seek tawfiq — Allah will guide you to the domain where your knowledge brings the most good. This is the researcher's highest goal — knowledge for good.</div>

<div class="secret-box">🧭 তোমার সিদ্ধান্ত: interest + strength + market + purpose। চারটে মিলিয়ে বেছে নাও। তোমার প্রোফাইলের জন্য: MLSys (AI+Systems) = primary, AI4SE = secondary, Data = safety। তাওফিক চাও — আল্লাহ সঠিক পথ দেখাবেন।</div>`
});
