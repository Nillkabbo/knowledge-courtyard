...
<div class="dialogue">সুহবত — সঙ্গ, সাথী খোঁজা। ইসলামে সঙ্গের গুরুত্ব অনেক — নবীজি (সা) বলেছেন, "মানুষ তার বন্ধুর দ্বীনে থাকে।" (আবু দাউদ ৪৮৩৩) PhD-তেও সঙ্গ গুরুত্বপূর্ণ — কোন প্রফেসরের সাথে, কোন ল্যাবে। কোল্ড ইমেইল হলো সেই সঙ্গ খোঁজা — আগে থেকে, নিয়ত সহকারে। যে সঙ্গ খোঁজে, সে পায়। যে অপেক্ষা করে, সে হারায়।</div>
...
<div class="secret-box"><div class="label">দশম স্থান — রহস্য</div><div class="text">🎓 PhD = মুকুট নয়, চাবি। জ্ঞানের চাবি।<br><small>স্বাধীনতা + একাকীত্ব + ব্যর্থতা = সৃষ্টি। ইলম ইবাদত — জ্ঞান সৃষ্টি সবচেয়ে গভীর ইবাদত।</small></div></div>`,
  senior:{
    title:"PhD জীবনের বাস্তবতা — টিকে থাকার নিয়ম",
    body:`<p><strong>১. স্বাধীনতা = দায়িত্ব:</strong> কেউ তোমার সময়সূচী বানাবে না। নিজের সাপ্তাহিক ছক বানাও — রিসার্চ, কোর্স, বিশ্রাম সব রাখো।</p><p><strong>২. একাকীত্ব = সঙ্গ:</strong> ল্যাবের সহকর্মীরাই নতুন পরিবার। সপ্তাহে অন্তত একবার peer আলোচনা রাখো।</p><p><strong>৩. ব্যর্থতা = তথ্য:</strong> প্রতিটা failed experiment লিখে রাখো — negative result-ও ফলাফল।</p><p><strong>৪. মানসিক স্বাস্থ্য = রিসার্চের অংশ:</strong> ঘুম, ব্যায়াম, কমিউনিটি — luxury নয়, infrastructure। প্রয়োজনে কাউন্সেলিং সাহায্য নাও — Evans et al. (2018) অনুযায়ী উপসর্গ খুবই সাধারণ।</p><p><strong>৫. মুকুট = চাবি:</strong> PhD শেষ নয় — জ্ঞান সৃষ্টির জীবনের শুরু। ইলম ইবাদত — চিরচেষ্টা (কুরআন ৫৩:৩৯)।</p>`
  }
});
