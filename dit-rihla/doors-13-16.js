...
doors.push({
  ...
  color: "#5eead4",
  name: "সংখ্যার মিনার",
  subtitle: "The Minaret of Numbers — Quantitative Research (RSH 6003)",
...
<div class="callout tip"><span class="co-icon">🔗</span><div><strong>রিহলা-সেতু:</strong> তোমার লাইব্রেরির Book 34 (Scale of Evidence) এই মিনারের পূর্ণ গভীরতা — Al-Kindi থেকে Pearl পর্যন্ত ১০ দরজা। RSH 6003 চলাকালে সেই বইটা পাশে রাখো।</div></div>
...
<div class="secret-box">📏 সংখ্যা সাক্ষী, বিচারক নয় — প্রশ্ন সাজাও (variable-sample-control), কাকতালীয়তার হিসাব করো (p-value), প্রভাবের আকার মাপো (effect size)। Significant ≠ গুরুত্বপূর্ণ।</div>`,
  senior: {
    title: "RSH 6003 — ঢোকার আগে, বেরোনোর পর",
...
doors.push({
  ...
  subtitle: "The Tea-House of Stories — Qualitative Research (RSH 6013)",
...
<div class="secret-box">🫖 সংখ্যা মাপে প্রশ্নের <em>আকার</em>, গল্প খোলে প্রশ্নের <em>গভীরতা</em> — খোলা প্রশ্ন → কোডিং → থিম → saturation → ত্রিভুজায়ন: মুহাদ্দিসের পাঁচ ধাপ, আজও সোনার মানের।</div>`,
  senior: {
    title: "RSH 6013 — ঢোকার আগে, বেরোনোর পর",
...
doors.push({
  ...
  subtitle: "The Architect's Palace — Research Design (RSH 6023)",
  ...
  story: `<p class="scene-setting">রিসার্চ-শহরের তৃতীয় স্টেশন এক স্থপতির প্রাসাদ — দেয়ালে শত নকশা, টেবিলে অসমাপ্ত এক নগর-পরিকল্পনা। প্রধান স্থপতি বলেন, "মিনারে তুমি যন্ত্র শিখেছ (RSH 6003), চায়ের দোকানে শোনা শিখেছ (RSH 6013)। এখন শিখবে <strong>গবেষণা নির্মাণ</strong> — কারণ যন্ত্র ভুল জায়গায় বসালে সুন্দর সংখ্যাও মিথ্যা প্রাসাদ তোলে। আমার চার প্রশ্ন: <strong>কী প্রশ্ন (question), কোন নকশা (design), কাদের নিয়ে (sample), কী নিয়মে (ethics)</strong>।" তিনি এক নকশা দেখালেন — কাকতালীয় ভেদ নির্মূলের চার রূপ: true-experimental (দল-বিভাজন যথেচ্ছ), quasi (প্রাকৃতিক দল), correlational (শুধু পর্যবেক্ষণ), আর qualitative বিন্যাস। প্রতিটির পাশে লাল কালিতে: <strong>ভাঙার জায়গা</strong> — history, maturation, selection-bias... "এগুলো আমাদের ভূমিকম্প; নকশা এমন যেন ভূমিকম্প-সহনশীল হয়।" এই প্রাসাদের নাম RSH 6023 — Research Design।</p>
<p class="scene-setting en">The research city's third station is an architect's palace — a hundred blueprints on the walls, an unfinished city-plan on the table. The chief architect says, "In the minaret you learned instruments (RSH 6003); in the tea-house, listening (RSH 6013). Now you learn <strong>research construction</strong> — for an instrument placed wrongly raises a beautiful palace of numbers upon lies. My four questions: <strong>what question, which design, on whom, under what rules (ethics)</strong>." He showed one blueprint — four forms of eliminating coincidence: true-experimental (random assignment), quasi (natural groups), correlational (observation only), and qualitative layouts. Beside each, in red ink: <strong>fracture points</strong> — history, maturation, selection-bias... "These are our earthquakes; the design must be quake-resistant." This palace is RSH 6023 — Research Design.</p>
...
<div class="secret-box">📐 গবেষণা প্রাসাদের চার স্তম্ভ: প্রশ্ন → নকশা → নমুনা → নীতি; দেয়ালের লাল-দাগ হলো validity-হুমকি — ভূমিকম্প-সহনশীল নকশাই ডিজার্টেশন বাঁচায়।</div>`,
  senior: {
    title: "RSH 6023 — ঢোকার আগে, বেরোনোর পর",
...
doors.push({
  ...
  color: "#5eead4",
  name: "গবেষণার তাঁত",
  subtitle: "The Loom of Research — Advanced Methodology & Academic Writing (RSH 6033)",
...
<div class="callout tip"><span class="co-icon">🔗</span><div><strong>রিহলা-সেতু:</strong> তোমার লাইব্রেরির Book 27 (Research Paper Craftsman — IMRaD, ৩-পাস পড়া) এবং Book 26 (Knowledge Craftsman — Zettelkasten নোট) এই তাঁতের দুই হাতিয়ার। RSH 6033 চলাকালে সেগুলো মুখস্থ থাকবে তো কোর্স বাতাসের মত লাগবে।</div></div>
...
<div class="secret-box">🧵 গবেষণার ফল নয়, <em>লেখা</em> গবেষণার ফল — সাদা (প্রশ্ন) × নীল (সাহিত্য) × সোনালি (সংযোজন) সুতোয় বোনো IMRaD-কাপড়; voice বদলাও: developer → researcher। এই তাঁত পেরোলেই প্রস্তাবনার দরজা।</div>`,
  senior: {
    title: "RSH 6033 — ঢোকার আগে, বেরোনোর পর (রিসার্চ-চতুষ্টয় সমাপ্তি)",
