...
<div class="dialogue en">"Khatm — seal, finality, end. Allah called the Prophet 'khataman nabiyyin' — the seal of prophets, the last (33:40). Khatm means final — once, complete, no repetition. Idempotency is the shadow of khatm — once done is final, not repeated. Retry without seal = confusion, duplication, harm. Retry with seal = safety, certainty, finality. Stamp every important action — idempotency key."</div><div class="callout warn" data-door="15"><span class="co-icon">⚠️</span><div><strong>বাস্তব বিপদ:</strong> Rate limit failure: কোনো limit ছিল না। DDoS — ১০ মিনিটে $৫০,০০০ বিল। Token bucket, leaky bucket।</div></div>

<div class="secret-box">🛡️ Rate limiting = প্রতি ইউজার request সীমা। API gateway = ফটক প্রহরী।</div>
`,
  senior:{
