...
<div class="dialogue">আটটা স্থান পেরিয়েছ। ফটক রক্ষক বলেছিলেন — ভাগ করো। গোলাঘর রক্ষক বলেছিলেন — কাছে রাখো। সংরক্ষণাগারিক বলেছিলেন — সঠিক ঘর বাছো। সংকেত প্রহরী বলেছিলেন — বার্তাবাহক দাও। চৌরাস্তার মানচিত্রকার বলেছিলেন — আপস বেছে নাও। শুল্ক আদায়ক বলেছিলেন — নিয়ন্ত্রণ রাখো। ঝড় প্রহরী বলেছিলেন — বিকল হলে সবর করো। আর আমি বলি — সবকিছু মাপো। এই আটটা নীতির সমন্বয়ই একটা নগরী। একটা single server থেকে একটা scalable, resilient, observable system-এ। এটাই System Design।</div>
<div class="dialogue en">"You've passed eight places. The gate keeper said — distribute. The granary keeper said — keep close. The archivist said — choose the right home. The signal watcher said — use messengers. The crossroads cartographer said — choose trade-offs. The customs collector said — maintain control. The storm watcher said — be patient when things fail. And I say — measure everything. The synthesis of these eight principles is a city. From a single server to a scalable, resilient, observable system. This is System Design."</div>
