// ══════════════════════════════════════
// Book 41 · Theory of Computation — Engine
// ══════════════════════════════════════
let state = { xp:0, currentDoor:null, completedDoors:[], prologueSeen:false };
const XP_PER_DOOR = 100;
const SAVE_KEY = 'theoryOfComputation_v1';
const MAX_XP = 1000;
const RANKS = [
  {min:0,   name:'সন্ধানী',        icon:'🔍'},
  {min:100, name:'প্যাটার্ন পাঠক',  icon:'🔤'},
  {min:200, name:'গ্রামার কারিগর',  icon:'📜'},
  {min:300, name:'যন্ত্র নির্মাতা',  icon:'⚙️'},
  {min:400, name:'সীমাবদ্ধতা জ্ঞানী', icon:'🚧'},
  {min:500, name:'জটিলতা বিশ্লেষক', icon:'📊'},
  {min:600, name:'হ্রাসকারী',       icon:'🔄'},
  {min:700, name:'সর্বজ্ঞ গণনাকারী', icon:'🧮'}
];
