// ════════════════════════════════════════
// Book 62 · The Twelve-Line Engine — Engine
// ════════════════════════════════════════
let state = { xp:0, currentDoor:null, completedDoors:[], prologueSeen:false };
const XP_PER_DOOR = 100;
const SAVE_KEY = 'twelveLineEngine_v3';
const MAX_XP = 2800;
const RANKS = [
  {min:0,    name:'জমি-হাঁটা শাগরেদ',   icon:'📏'},
  {min:100,  name:'নৌকার কারিগর',       icon:'⛵'},
  {min:300,  name:'রুট-খাতার চালক',     icon:'🚆'},
  {min:500,  name:'দলের কারিগর',        icon:'🏫'},
  {min:800,  name:'মুনশির শাগরেদ',      icon:'✉️'},
  {min:1000, name:'টেবিল-সাজানো',       icon:'🗂️'},
  {min:1300, name:'চিরকুট-লেখক',        icon:'🧾'},
  {min:1600, name:'দেয়াল-নির্মাতা',     icon:'🧱'},
  {min:1900, name:'বহু-ভাষার দোভাষী',   icon:'🖋️'},
  {min:2200, name:'যাচাইয়ের প্রহরী',     icon:'🔏'},
  {min:2500, name:'নকশা-কারিগর',        icon:'📝'},
  {min:2800, name:'ইঞ্জিন-নির্মাতা',     icon:'⚙️'}
];
