...
<div class="dialogue">আদল। আল্লাহ কুরআনে বলেন: <em>"আল্লাহ এমন নন যিনি দেখতে বা শুনতে পান না — এমন উপমা দেন না। যারা জানে তারা জানে যে সত্য তোমার রবের কাছ থেকে এসেছে।"</em> (এটি আদলের আয়াতের ভিত্তিতে প্যারাফ্রেজ।) আদল মানে একটা জিনিসের গঠন যাচাই করা — কাঠের জোড় কি ঠিক? কাঠ কি পচা নয়? ফিট কি ঠিক? যুক্তির আদল নেওয়া মানে — প্রতিটা প্রিমিস ধরে ধরে দেখা, জোড় ধরে ধরে দেখা। ইউসুফ যখন দরজা বানান, তিনি প্রতিটা জোড় ধরে দেখেন — চাপ দেন, নাড়ান। সেটাই আদল। তোমারও প্রতিটা যুক্তি এভাবে যাচাই করতে হবে।</div>
<div class="dialogue en">Adl. Allah says in the Quran (paraphrased from verses on adl): the truth has come from your Lord. Adl means examining a thing's structure — is the wood joint correct? Is the wood not rotten? Is the fit right? Taking the adl of an argument means — examining each premise, examining each joint. When Yusuf makes a door, he checks every joint — pushes, shakes. That is adl. You too must examine every argument this way.</div>
...
<div class="dialogue">রুকাইয়া একটা খাতা খুললেন। "দেখো — এই খাতায় দুটো কলাম। বাঁ দিকে 'পূর্ব-বিশ্বাস' — আগে থেকে যা জানতে। ডান দিকে 'নতুন প্রমাণ' — এখন যা জানলাম। আমি হিসাবরক্ষক। আমার কাজ হলো এই দুটো কলাম মিলিয়ে নতুন ব্যালেন্স বের করা।" তিনি খাতায় লিখলেন: <em>পূর্ব-বিশ্বাস + নতুন প্রমাণ = নতুন বিশ্বাস</em>। "এটাই বেইসিয়ান আপডেট। থমাস বেইস — একজন পাদরি, ১৭৬৩ সালে মৃত্যুর পর তাঁর সূত্র প্রকাশ পায়। তিনি একটা সহজ কথা বলেছিলেন — <strong>নতুন প্রমাণ পূর্বের বিশ্বাসকে বদলায়, কিন্তু মুছে দেয় না।</strong>"</div>
...
<div class="dialogue">তুমি জিজ্ঞেস করলে — "তাহলে কি আমি কখনো নিশ্চিত হতে পারি না?" রুকাইয়া খাতা বন্ধ করলেন। "না। নিশ্চিত হওয়া যায় না — শুধু সম্ভাবনা আপডেট করা যায়। মার্ক আন্দ্রিসেন বলেছেন — <em>'strong opinions, weakly held.'</em> শক্ত মতামত, কিন্তু দুর্বলভাবে ধরা — নতুন প্রমাণ এলে ছেড়ে দিতে প্রস্তুত। এটাই বেইসিয়ান জীবন। তুমি একটা মতামত ধরে থাকো — কিন্তু প্রতিটা নতুন তথ্যে খাতা আপডেট করো। যে মতামত কখনো বদলায় না, সে বিশ্বাস নয় — অন্ধত্ব।"</div>
<div class="dialogue en">You asked — "So can I never be certain?" Rukayya closed the ledger. "No. Certainty isn't possible — only updating probability. Marc Andreessen said — <em>'strong opinions, weakly held.'</em> Strong opinions, held weakly — ready to let go when new evidence comes. This is the Bayesian life. You hold an opinion — but with each new piece of information, update the ledger. An opinion that never changes isn't belief — it's blindness."</div>
