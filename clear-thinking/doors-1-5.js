...
<div class="callout tip"><span class="co-icon">📋</span><div>— Build Your Latticework —
  ...
  one tool = hammer-man
  many tools, wisely used = hikmah</div></div>
...
doors.push({
  ...
  secret:"যুক্তি হলো কাঠের জোড়। মর্টিস-টেনন জয়েন্ট — একটা কাঠে গর্ত, আরেকটা কাঠে খুঁটি, খুঁটি গর্তে ঢুকে যায়। ভালো যুক্তি ধরে রাখে। খারাপ যুক্তি ভেঙে যায়। কিন্তু জোড় ভালো হলেও কাঠ পচা হলে কাজ হবে না — সেটাই সাউন্ডনেস। আর জোড়টাই যদি ভুল হয় — সেটাই ইনভ্যালিডিটি। এই দুটো আলাদা ভুল, দুটো আলাদা কারিগরি। জোড় আর কাঠ — দুটোই যাচাই করার নামই আদল।",
  recall:{
...
<div class="dialogue">তুমি বললে — "কিন্তু আমি তো জানি যে আমি মানুষ। তাহলে প্রথম যুক্তিটা কি ভুল?" ইউসুফ হাসলেন। "সিদ্ধান্তটা তোমার কাছে সত্য মনে হচ্ছে কারণ তুমি আগে থেকেই জানো। কিন্তু যুক্তিটা <em>বৈধ</em> নয় — অর্থাৎ সেই গঠনে প্রিমিস সত্য হলেও সিদ্ধান্ত মিথ্যা হতে পারে। একটা যুক্তি যাচাই করার সঠিক উপায় হলো — ভাবো, <em>এই গঠনে</em> অন্য প্রিমিস বসালে কী হতে পারে?"</div></div>
...
<div class="callout tip"><span class="co-icon">📋</span><div>— Fallacy Checklist —
  ...
  final step:
    ...
    argument for cracks → sidq</div></div>
...
doors.push({
  ...
  secret:"প্রতিটা বিশ্বাসের একটা দাম আছে — সম্ভাবনা। নতুন প্রমাণ এলে দাম বদলায়। কিন্তু অনেকে নতুন প্রমাণ দেখে পুরোনো দাম ভুলে যায় — সেটাই বেস-রেট অবহেলা। রুকাইয়ার খাতায় দুটো কলাম — আগের বিশ্বাস, নতুন প্রমাণ। দুটো মিলে নতুন বিশ্বাস। এটাই বেইসিয়ান আপডেট। যে এটা জানে সে কখনো একটা পরীক্ষার ফল দেখে প্যানিক করে না। প্রমাণ দিয়ে গড়া এই প্রত্যয়ের নামই ইলম আল-ইয়াকিন।",
  recall:{
