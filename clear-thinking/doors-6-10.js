...
doors.push({
  ...
  secret:"পলিয়ার চার ধাপ: বুঝো → পরিকল্পনা → বানাও → ফিরে তাকাও। সেম-রিপার তৈরি রাখো।",
  senior:{
    title:"পলিয়ার চার ধাপ এক নজরে",
    body:`<table class="kv-table"><tr><th>ধাপ</th><th>প্রশ্ন</th></tr>
<tr><td class="hl">১. Understand</td><td>সমস্যাটা আসলে কী? কী দেওয়া, কী চাওয়া?</td></tr>
<tr><td class="hl">২. Plan</td><td>কোন পথে যাবে? কোন মডেল ফিট?</td></tr>
<tr><td class="hl">৩. Execute</td><td>পরিকল্পনা চালাও — ধাপে ধাপে</td></tr>
<tr><td class="hl">৪. Review</td><td>ফল কি মাপের সাথে মেলে? কী শিখলে?</td></tr></table>
<p>প্রতিটা ধাপে ফিরে তাকাও — সেম-রিপার তৈরি রাখো (ভুল হবেই, শুধরানোই শেখা)।</p>`
  },
  recall:{
...
<div class="verse">إِنَّ فِي خَلْقِ السَّمَاوَاتِ وَالْأَرْضِ وَاخْتِلَافِ اللَّيْلِ وَالنَّهَارِ لَآيَاتٍ لِّقَوْمٍ يَتَفَكَّرُونَ</div>
<div style="font-size:.85rem;color:var(--ink-dim);text-align:center;margin-bottom:1rem">"নিশ্চয়ই আসমানসমূহ ও পৃথিবীর সৃষ্টিতে এবং রাত ও দিনের আবর্তনে চিন্তাশীল জাতির জন্য নিদর্শন রয়েছে।" — কুরআন ৩:১৯০</div>
...
doors.push({
  ...
  secret:"বড় অজানাকে ভেঙে আন্দাজ করো — আর নিজের আন্দাজ ক্যালিব্রেট করতে শেখো।",
  senior:{
    title:"ফার্মি অনুমান এক নজরে",
    body:`<table class="kv-table"><tr><th>ধাপ</th><th>উদাহরণ: ঢাকায় কত রিকশা?</th></tr>
<tr><td class="hl">Decompose</td><td>জনসংখ্যা × যাত্রী % ÷ যাত্রা/দিন</td></tr>
<tr><td class="hl">Estimate each</td><td>প্রতিটা অংশ আলাদা আন্দাজ</td></tr>
<tr><td class="hl">Multiply</td><td>সব একসাথে গুণ</td></tr>
<tr><td class="hl">Sanity check</td><td>১০ গুণ বেশি/কম হলে ভুল কোথাও</td></tr></table>
<p>ক্যালিব্রেশন: নিজের আন্দাজের ভুল ট্র্যাক করো — বেশিরভাগ মানুষ অতি-আত্মবিশ্বাসী।</p>`
  },
  recall:{
...
<div class="verse">قُل لَّا يَعْلَمُ مَن فِي السَّمَاوَاتِ وَالْأَرْضِ الْغَيْبَ إِلَّا اللَّهُ</div>
<div style="font-size:.85rem;color:var(--ink-dim);text-align:center;margin-bottom:1rem">"বলো, আসমান ও পৃথিবীতে যারা আছে তারা অদৃশ্য জানে না — আল্লাহ ছাড়া।" — কুরআন ২৭:৬৫</div>
...
doors.push({
  ...
  secret:"একমুখী দরজায় ধীরে, দ্বিমুখী দরজায় দ্রুত — চেষ্টা করো, ফল আল্লাহর উপর ছাড়ো।",
  senior:{
    title:"সিদ্ধান্তের নিয়ম এক নজরে",
    body:`<table class="kv-table"><tr><th>দরজার ধরন</th><th>গতি</th><th>টুল</th></tr>
<tr><td class="hl">একমুখী (irreversible)</td><td>ধীরে</td><td>পরামর্শ + প্রিমর্টেম + সময়</td></tr>
<tr><td class="hl">দ্বিমুখী (reversible)</td><td>দ্রুত</td><td>পরীক্ষা + ফিডব্যাক + সংশোধন</td></tr></table>
<ul class="checklist">
<li>প্রত্যাশিত মান হিসাব করো (উপকার × সম্ভাবনা)</li>
<li>অনুশোচনা ফ্রেম: ১০ মিনিট / ১০ মাস / ১০ বছর পর কেমন লাগবে?</li>
<li>Satisficing: সবচেয়ে ভালোর পেছনে না ছুটে যথেষ্ট ভালো নাও</li>
</ul>`
  },
  recall:{
...
<div class="callout tip"><span class="co-icon">📋</span><div>— Decision Under Uncertainty —
  ...
  <div class="verse">
    <div class="verse-arabic">وَعَسَىٰ أَن تَكْرَهُوا شَيْئًا وَهُوَ خَيْرٌ لَّكُمْ</div>
    <div class="verse-translation">এমন হতে পারে, তোমরা কোনো কিছুকে অপছন্দ করো, অথচ সেটা তোমাদের জন্য কল্যাণকর।</div>
    <div class="verse-ref">— কুরআন ২:২১৬</div>
  </div>
...
doors.push({
  ...
  secret:"প্রতিটা ফলেরও ফল আছে — 'তারপর কী?' জিজ্ঞেস করো, কোবরা ইফেক্ট এড়াও।",
  senior:{
    title:"দ্বিতীয়-স্তরের চিন্তা এক নজরে",
    body:`<table class="kv-table"><tr><th>স্তর</th><th>প্রশ্ন</th></tr>
<tr><td class="hl">First-order</td><td>এটা করলে কী হবে?</td></tr>
<tr><td class="hl">Second-order</td><td>তারপর কী হবে?</td></tr>
<tr><td class="hl">Third-order</td><td>তারপরের তারপর? কে প্রতিক্রিয়া দেখাবে?</td></tr></table>
<p>কোবরা ইফেক্ট: ইনসেনটিভ দাও → মানুষ সিস্টেম গেম করে → ফল উল্টো। প্রতিটা ইনসেনটিভ ডিজাইনে "মানুষ এটা কীভাবে অপব্যবহার করবে?" জিজ্ঞেস করো।</p>`
  },
  recall:{
...
doors.push({
  ...
  secret:"নয় সূত্র এক কাপড়ে — সুচিন্তিত জীবন। তুমি এখন তাঁতের কারিগর।",
  senior:{
    title:"নয় সূত্রের তাঁত এক নজরে",
    body:`<table class="kv-table"><tr><th>দরজা</th><th>শিক্ষক</th><th>সূত্র</th></tr>
<tr><td class="hl">১</td><td>জাকিরা</td><td>মডেলের তাঁত (হিকমাহ)</td></tr>
<tr><td class="hl">২</td><td>ইউসুফ</td><td>যুক্তির জোড় (আদল)</td></tr>
<tr><td class="hl">৩</td><td>নাফিসা</td><td>ফলেসির ফাটল (সিদক)</td></tr>
<tr><td class="hl">৪</td><td>রুকাইয়া</td><td>সম্ভাবনার খাতা (ইলম আল-ইয়াকিন)</td></tr>
<tr><td class="hl">৫</td><td>সুলতান</td><td>ভিত্তির হাপ (ফাতরাত)</td></tr>
<tr><td class="hl">৬</td><td>হালিমা</td><td>সমাধানের কাঁচি (তাফাক্কুর)</td></tr>
<tr><td class="hl">৭</td><td>আবদুল্লাহ</td><td>আন্দাজের পাল্লা (জান্ন বিল-গায়িব)</td></tr>
<tr><td class="hl">৮</td><td>ইব্রাহিম</td><td>সিদ্ধান্তের দিকনির্ণয় (ইস্তিখারাহ)</td></tr>
<tr><td class="hl">৯</td><td>সালমা</td><td>ফলের ফল (তাদবির)</td></tr></table>`
  },
  recall:{
...
<div class="verse">وَمَن يُؤْتَ الْحِكْمَةَ فَقَدْ أُوتِيَ خَيْرًا كَثِيرًا</div>
<div style="font-size:.85rem;color:var(--ink-dim);text-align:center;margin-bottom:1rem">"যাকে হিকমাহ দেওয়া হয়েছে, তাকে প্রভুত কল্যাণ দেওয়া হয়েছে।" — কুরআন ২:২৬৯</div>
