...
<div class="dialogue">"জর্জ পলিয়া," হালিমা বললেন, "একজন হাঙ্গেরিয়ান গণিতজ্ঞ। ১৯৪৫ সালে তিনি একটা বই লিখেছিলেন — <em>How to Solve It</em>। সেই বইয়ে তিনি সমস্যা সমাধানের চারটে ধাপ দিলেন। আমি সেই চার ধাপ দিয়ে প্রতিটা জামা বানাই। তুমি সেই চার ধাপ দিয়ে প্রতিটা সমস্যা সমাধান করবে।"</div></div>
<div class="dialogue en">"George Polya," Halima said, "a Hungarian mathematician. In 1945 he wrote a book — <em>How to Solve It</em>. In it he gave four steps to solve problems. I make every garment with those four steps. You'll solve every problem with those four steps."</div></div>
...
<div class="dialogue en">"Fourth step — look back," Halima held up the unfinished coat. "Making the garment isn't the end. I have it worn — where tight? Where loose? Does the arm move? Real improvement comes here." She paused. "Your code too. Running isn't the end. Read your own code. Where ugly? Where repetitive? Where names unclear? Read your code a week later — if you can't understand, it's not a solution, it's a burden."</div></div>
...
<div class="dialogue">"ফার্মি একটা প্রশ্ন ভালোবাসতেন," আবদুল্লাহ বললেন। "<em>'শিকাগোতে কতজন পিয়ানো টিউনার আছে?'</em> কেউ জানে না। কিন্তু ফার্মি বললেন — ভাঙো।" আবদুল্লাহ আবাকাসে গোটা সাজালেন। "এক — শিকাগোর জনসংখ্যা কত? ~৩০ লক্ষ। দুই — কত পরিবার? ~১০ লক্ষ। তিন — কত পরিবারে পিয়ানো? ধরো ২০-এ একটা। তাহলে ৫০,০০০ পিয়ানো। চার — একটা পিয়ানো বছরে কতবার টিউন করা যায়? একবার। ৫০,০০০ টিউনিং। পাঁচ — একজন টিউনার বছরে কত টিউন করেন? ধরো ১০০০। তাহলে দরকার ৫০ জন।"</div></div>
<div class="dialogue en">"Fermi loved a question," Abdullah said. "<em>'How many piano tuners are in Chicago?'</em> Nobody knows. But Fermi said — decompose." Abdullah arranged beads on the abacus. "One — Chicago's population? ~3 million. Two — how many households? ~1 million. Three — how many have pianos? Say 1 in 20. Then 50,000 pianos. Four — how often tuned per year? Once. 50,000 tunings. Five — how many tunings per tuner per year? Say 1000. Then need 50 tuners."</div></div>
...
<div class="dialogue">"আসল সংখ্যা কত?" আবদুল্লাহ বললেন। "তখন ছিল ~৬০। ৫০ এর আন্দাজ — ৬০ এর বাস্তব। কাছাকাছি! কিন্তু মূল পয়েন্ট সঠিক সংখ্যা নয় — মূল পয়েন্ট পদ্ধতি। তুমি যদি জানো কীভাবে ভাঙতে হয়, তুমি যেকোনো প্রশ্নের কাছাকাছি যেতে পারবে।"</div></div>
<div class="dialogue en">"What was the actual number?" Abdullah said. "It was ~60. The estimate of 50 — the reality of 60. Close! But the main point isn't the exact number — it's the method. If you know how to decompose, you can approach any question."</div></div>
...
<div class="dialogue en">"You're a developer," Abdullah said. "You get Fermi questions daily. 'How much data will this DB hold?' 'How many requests can this API handle?' 'How long will the migration take?' No one gives you the exact answer. But you can decompose. DB — bytes per row? * rows? * indexes? * replicas? API — time per request? * peak users? * requests per user?"</div></div>
...
<div class="dialogue">"এখন সবচেয়ে কঠিন অংশ," আবদুল্লাহ গম্ভীর হলেন। "ক্যালিব্রেশন। তুমি যখন বলো — 'আমি ৯০% নিশ্চিত এই সংখ্যাটা এই সীমার মধ্যে।' তোমার সেই আন্দাজগুলো কি সত্যিই ৯০% সময় সঠিক? ফিলিপ টেটলক (২০০৫) একটা দশক ধরে বিশেষজ্ঞদের আন্দাজ যাচাই করেছেন। দেখেছেন — যারা '৮০% নিশ্চিত' বলে, তাদের আসলে মাত্র ~৪৫% সময় সঠিক — টেটলক একে বলেছেন 'ছুঁড়ি মারা শিম্পাঞ্জি'। অতি-আত্মবিশ্বাস। এটাই সবচেয়ে বড় ভুল — নিজেকে না চেনা।"</div></div>
<div class="dialogue en">"Now the hardest part," Abdullah grew serious. "Calibration. When you say — 'I'm 90% sure this number is within this range.' Are your estimates actually right 90% of the time? Philip Tetlock (2005) verified experts' estimates over a decade. Found — those who say '80% sure' are actually right only ~45% of the time — Tetlock's famous "dart-throwing chimpanzee" result. Overconfidence. This is the biggest error — not knowing yourself."</div></div>
...
<div class="callout tip"><span class="co-icon">📋</span><div>— Fermi Estimation Protocol —
  ...
  adjust future estimates
    based on your track record</div></div>
...
<div class="callout tip"><span class="co-icon">📋</span><div>— Decision Under Uncertainty —
  ...
  // STEP 5: istikhara
  //   after all effort,
  //   surrender outcome to Allah</div></div>
...
<div class="dialogue">"এখন একটা কাল্পনিক উদাহরণ," সালমা মাটিতে আঙুল দিয়ে দাগ টানলেন। "ব্রিটিশ আমলে দিল্লিতে কোবরা সাপ বেশি ছিল। সরকার একটা সিদ্ধান্ত নিল — মৃত কোবরা আনলে টাকা দেওয়া হবে।" সালমা একটু থামলেন। "প্রথম-স্তরের ফল কী? কোবরা কমল — মানুষ মেরে টাকা আনছে। সরকার খুশি। কিন্তু দ্বিতীয়-স্তরের ফল কী?"</div></div>
...
<div class="callout tip"><span class="co-icon">📋</span><div>— Daily Clear Thinking Checklist —
  ...
  # 9. আগামীকাল কী শিখব? (growth mindset)</div></div>
